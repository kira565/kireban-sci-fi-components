...
import vn, { useRef as er, useEffect as Cn, useMemo as bn, createElement as wn } from "react";
var jt = { exports: {} }, yt = {};
/**
 * @license React
...
function Tn() {
  ...
  return yt.Fragment = e, yt.jsx = t, yt.jsxs = t, yt;
}
var vt = {};
/**
 * @license React
...
` + se[I].replace(
        ...
        Kt = !1, ve.H = L, n(), Error.prepareStackTrace = S;
      }
      return se = (se = h ? h.displayName || h.name : "") ? s(se) : "", typeof h == "function" && Qt.set(h, se), se;
    }
    function l(h) {
      if (h == null) return "";
      if (typeof h == "function") {
    ...
    function m(h, O, S, L, ee, I) {
      if (typeof h == "string" || typeof h == "function" || h === T || h === E || h === k || h === D || h === j || h === U || typeof h == "object" && h !== null && (h.$$typeof === B || h.$$typeof === G || h.$$typeof === N || h.$$typeof === b || h.$$typeof === z || h.$$typeof === Me || h.getModuleId !== void 0)) {
        var M = O.children;
        if (M !== void 0)
          if (L)
            if (nt(M)) {
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
    ...
    function c(h, O) {
      if (typeof h == "object" && h && h.$$typeof !== yn) {
        if (nt(h))
...
Check the top-level render call using <` + h + ">."), O;
    ...
    var w = vn, C = Symbol.for("react.transitional.element"), x = Symbol.for("react.portal"), T = Symbol.for("react.fragment"), k = Symbol.for("react.strict_mode"), E = Symbol.for("react.profiler"), b = Symbol.for("react.consumer"), N = Symbol.for("react.context"), z = Symbol.for("react.forward_ref"), D = Symbol.for("react.suspense"), j = Symbol.for("react.suspense_list"), G = Symbol.for("react.memo"), B = Symbol.for("react.lazy"), U = Symbol.for("react.offscreen"), X = Symbol.iterator, he = Symbol.for("react.client.reference"), ve = w.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, ze = Object.prototype.hasOwnProperty, de = Object.assign, Me = Symbol.for("react.client.reference"), nt = Array.isArray, ne = 0, we, Wr, Yr, Br, Ur, $r, Gr;
    r.__reactDisabledLog = !0;
    var Jt, Xr, Kt = !1, Qt = new (typeof WeakMap == "function" ? WeakMap : Map)(), yn = Symbol.for("react.client.reference"), Zr, qr = {}, Hr = {}, Jr = {};
    vt.Fragment = T, vt.jsx = function(h, O, S, L, ee) {
      return m(h, O, S, !1, L, ee);
    }, vt.jsxs = function(h, O, S, L, ee) {
      return m(h, O, S, !0, L, ee);
    };
  }()), vt;
}
var ei;
function En() {
  return ei || (ei = 1, process.env.NODE_ENV === "production" ? jt.exports = Tn() : jt.exports = kn()), jt.exports;
}
var P = En();
const Gs = ({
  children: o,
...
var ge = {
  ...
  overwrite: !1,
  delay: 0
}, Tr, Q, V, Oe = 1e8, re = 1 / Oe, ur = Math.PI * 2, Sn = ur / 4, Pn = 0, vi = Math.sqrt, Mn = Math.cos, Rn = Math.sin, K = function(e) {
...
}, ie = Array.isArray, fr = /(?:-?\.?\d|\.)+/gi, bi = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, ot = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, tr = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, wi = /[+-]=-?[.\d]+/, Ti = /[^,'"\[\]\s]+/gi, Nn = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, W, Te, cr, Or, xe = {}, Wt = {}, ki, Ei = function(e) {
  return (Wt = dt(e, xe)) && ce;
}, Sr = function(e, t) {
  return console.warn("Invalid property", e, "set to", t, "Missing plugin? gsap.registerPlugin()");
}, Ot = function(e, t) {
  return !t && console.warn(e);
}, Oi = function(e, t) {
  return e && (xe[e] = t) && Wt && (Wt[e] = t) || xe;
}, St = function() {
  return 0;
}, An = {
  suppressEvents: !0,
  ...
  suppressEvents: !0
}, Pr = {}, Ye = [], hr = {}, Si, _e = {}, rr = {}, ti = 30, Vt = [], Mr = "", Rr = function(e) {
  var t = e[0], r, i;
  ...
  Ye.length && !Q && Yt(), e.render(t, r, Q && t < 0 && (e._initted || e._startAt)), Ye.length && !Q && Yt();
}, Ri = function(e) {
  var t = parseFloat(e);
  ...
  var t = e.parent || W, r = e.keyframes ? jn(ie(e.keyframes)) : ye;
  if (oe(e.inherit))
    for (; t; )
  ...
  return e._startAt && (Q ? e._startAt.revert(Ft) : e.vars.immediateRender && !e.vars.autoRevert || e._startAt.render(t, !0, i));
}, Vn = function o(e) {
  ...
  var r = e._dp;
  return r && r.smoothChildTiming && e._ts && (e._start = J(r._time - (e._ts > 0 ? t / e._ts : ((e._dirty ? e.totalDuration() : e._tDur) - t) / -e._ts)), qt(e), r._dirty || Qe(r, e)), e;
}, Li = function(e, t) {
  var r;
  if ((t._time || !t._dur && t._initted || t._start < e._time && (t._dur || !t.add)) && (r = Ut(e.rawTime(), t), (!t._dur || Lt(0, t.totalDuration(), r) - t._tTime > re) && t.render(r, !0)), Qe(e, t)._dp && e._initted && e._time >= e._dur && e._ts) {
  ...
  return t.parent && Ue(t), t._start = J((De(r) ? r : r || e !== W ? Ce(e, r, t) : e._time) + t._delay), t._end = J(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), Ai(e, t, "_first", "_last", e._sort ? "_start" : 0), _r(t) || (e._recent = t), i || Li(e, t), e._ts < 0 && Ht(e, e._tTime), e;
}, Di = function(e, t) {
  ...
  return a && !i && (e._time *= s / e._dur), e._dur = s, e._tDur = n ? n < 0 ? 1e10 : J(s * (n + 1) + e._rDelay * n) : s, a > 0 && !i && Ht(e, e._tTime = e._tDur * a), e.parent && qt(e), r || Qe(e.parent, e), e;
}, ni = function(e) {
  ...
  }[i] || 0 : !a && l && (f = i[0], d = i[1]), function(p, _, m) {
    var c = (m || t).length, g = s[c], y, v, w, C, x, T, k, E, b;
    if (!g) {
      ...
      for (g = s[c] = [], y = l ? Math.min(b, c) * f - 0.5 : i % b, v = b === Oe ? 0 : l ? c * d / b - 0.5 : i / b | 0, k = 0, E = Oe, T = 0; T < c; T++)
        w = T % b - y, C = v - (T / b | 0), g[T] = x = u ? Math.abs(u === "y" ? C : w) : vi(w * w + C * C), x > k && (k = x), x < E && (E = x);
      i === "random" && Fi(g), g.max = k - E, g.min = E, g.v = c = (parseFloat(t.amount) || parseFloat(t.each) * (b > c ? c - 1 : u ? u === "y" ? c / b : b : Math.max(b, c / b)) || 0) * (i === "edges" ? -1 : 1), g.b = c < 0 ? n - c : n, g.u = te(t.amount || t.each) || 0, r = r && c < 0 ? qi(r) : r;
    }
    return c = (g[p] - g.min) / g.max || 0, J(g.b + (r ? r(c) : c) * g.v) + g.u;
  };
}, gr = function(e) {
  ...
  return !r && Pe(e) && (i = r = e.radius || Oe, e.values ? (e = be(e.values), (n = !De(e[0])) && (i *= i)) : e = gr(e.increment)), Ge(t, r ? $(e) ? function(s) {
    ...
    for (var a = parseFloat(n ? s.x : s), l = parseFloat(n ? s.y : 0), u = Oe, f = 0, d = e.length, p, _; d--; )
      n ? (p = e[d].x - a, _ = e[d].y - l, p = p * p + _ * _) : p = Math.abs(e[d] - a), p < u && (u = p, f = d);
  ...
  if (e)
    if (e = !e.name && e.default || e, Er() || e.headless) {
      ...
      if (mt(), e !== i) {
        if (_e[t])
          return;
        ye(i, ye(Bt(e, n), s)), dt(i.prototype, dt(n, Bt(e, s))), _e[i.prop = t] = i, e.targetTest && (Vt.push(i), Pr[t] = 1), t = (t === "css" ? "CSS" : t.charAt(0).toUpperCase() + t.substr(1)) + "Plugin";
      }
  ...
  var i = e ? De(e) ? [e >> 16, e >> 8 & F, e & F] : 0 : wt.black, n, s, a, l, u, f, d, p, _, m;
  if (!i) {
  ...
  return t && !m && (n = i[0] / F, s = i[1] / F, a = i[2] / F, d = Math.max(n, s, a), p = Math.min(n, s, a), f = (d + p) / 2, d === p ? l = u = 0 : (_ = d - p, u = f > 0.5 ? _ / (2 - d - p) : _ / (d + p), l = d === n ? (s - a) / _ + (s < a ? 6 : 0) : d === s ? (a - n) / _ + 2 : (n - s) / _ + 4, l *= 60), i[0] = ~~(l + 0.5), i[1] = ~~(u * 100 + 0.5), i[2] = ~~(f * 100 + 0.5)), r && i.length < 4 && (i[3] = 1), i;
}, Xi = function(e) {
  var t = [], r = [], i = -1;
  ...
  if (n = n.map(function(p) {
    return (p = Gi(p, t, 1)) && s + (t ? p[0] + "," + p[1] + "%," + p[2] + "%," + p[3] : p.join(",")) + ")";
  ...
  var o = Date.now, e = 500, t = 33, r = o(), i = r, n = 1e3 / 240, s = n, a = [], l, u, f, d, p, _, m = function c(g) {
    var y = o() - i, v = g === !0, w, C, x, T;
    if ((y > e || y < 0) && (r += y - t), i += y, x = i - r, w = x - s, (w > 0 || v) && (T = ++d.frame, p = x - d.time * 1e3, d.time = x = x / 1e3, s += w + (w >= n ? 4 : n - w), C = 1), v || (l = u(c)), C)
  ...
  return d = {
    ...
    wake: function() {
      ki && (!cr && Er() && (Te = cr = window, Or = Te.document || {}, xe.gsap = ce, (Te.gsapVersions || (Te.gsapVersions = [])).push(ce.version), Ei(Wt || Te.GreenSockGlobals || !Te.gsap && Te || {}), Ui.forEach($i)), f = typeof requestAnimationFrame < "u" && requestAnimationFrame, l && d.sleep(), u = f || function(g) {
    ...
    add: function(g, y, v) {
      var w = y ? function(C, x, T, k) {
        g(C, x, T, k), d.remove(w);
      } : g;
      return d.remove(g), a[v ? "unshift" : "push"](w), mt(), w;
    },
    remove: function(g, y) {
      ~(y = a.indexOf(g)) && a.splice(y, 1) && _ >= y && _--;
    },
    _listeners: a
  }, d;
}(), mt = function() {
...
var Ki = function(e, t) {
  ...
  return e.delay = function(r) {
    ...
    if (n && n.smoothChildTiming && this._ts) {
      for (Ht(this, r), !n._dp || n.parent || Li(n, this); n && n.parent; )
    ...
    return this._rts = +r || 0, this._ts = this._ps || r === -1e-8 ? 0 : this._rts, this.totalTime(Lt(-Math.abs(this._delay), this._tDur, n), i !== !1), qt(this), Fn(this);
  }, e.paused = function(r) {
...
var ae = /* @__PURE__ */ function(o) {
  ...
  return t.to = function(i, n, s) {
    ...
    return n.duration = 0, n.parent = this, Tt(n).repeatDelay || (n.repeat = 0), n.immediateRender = !!n.immediateRender, new H(i, n, Ce(this, s), 1), this;
  }, t.call = function(i, n, s) {
    return ke(this, H.delayedCall(0, i, n), s);
  }, t.staggerTo = function(i, n, s, a, l, u, f) {
    return s.duration = n, s.stagger = s.stagger || a, s.onComplete = u, s.onCompleteParams = f, s.parent = this, new H(i, s, Ce(this, l)), this;
    ...
    var a = this._time, l = this._dirty ? this.totalDuration() : this._tDur, u = this._dur, f = i <= 0 ? 0 : J(i), d = this._zTime < 0 != i < 0 && (this._initted || !u), p, _, m, c, g, y, v, w, C, x, T, k;
    if (this !== W && f > l && i >= 0 && (f = l), f !== this._tTime || s || d) {
      if (a !== this._time && u && (f += this._time - a, i += this._time - a), p = f, C = this._start, w = this._ts, y = !w, d && (u || (a = this._zTime), (i || !n) && (this._zTime = i)), this._repeat) {
        if (T = this._yoyo, g = u + this._rDelay, this._repeat < -1 && i < 0)
          return this.totalTime(g * 100 + i, n, s);
        if (p = J(f % g), f === l ? (c = this._repeat, p = u) : (x = J(f / g), c = ~~x, c && c === x && (p = u, c--), p > u && (p = u)), x = _t(this._tTime, g), !a && this._tTime && x !== c && this._tTime - x * g - this._dur <= 0 && (x = c), T && c & 1 && (p = u - p, k = 1), c !== x && !this._lock) {
          var E = T && x & 1, b = E === (T && c & 1);
          if (c < x && (E = !E), a = E ? 0 : f % u ? u : f, this._lock = 1, this.render(a || (k ? 0 : J(c * g)), n, !u)._lock = 0, this._tTime = f, !n && this.parent && me(this, "onRepeat"), this.vars.repeatRefresh && !k && (this.invalidate()._lock = 1), a && a !== this._time || y !== !this._ts || this.vars.onRepeat && !this.parent && !this._act)
            return this;
          if (u = this._dur, l = this._tDur, b && (this._lock = 2, a = E ? u : -1e-4, this.render(a, !0), this.vars.repeatRefresh && !k && this.invalidate()), this._lock = 0, !this._ts && !y)
            return this;
          Hi(this, k);
        }
      }
      if (this._hasPause && !this._forcing && this._lock < 2 && (v = Yn(this, J(a), J(p)), v && (f -= p - (p = v._start))), this._tTime = f, this._time = p, this._act = !w, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = i, a = 0), !a && p && !n && !c && (me(this, "onStart"), this._tTime !== f))
        return this;
      if (p >= a && i >= 0)
        for (_ = this._first; _; ) {
          if (m = _._next, (_._act || p >= _._start) && _._ts && v !== _) {
            if (_.parent !== this)
              return this.render(i, n, s);
            if (_.render(_._ts > 0 ? (p - _._start) * _._ts : (_._dirty ? _.totalDuration() : _._tDur) + (p - _._start) * _._ts, n, s), p !== this._time || !this._ts && !y) {
              v = 0, m && (f += this._zTime = -1e-8);
              break;
            }
          }
          _ = m;
        ...
        _ = this._last;
        for (var N = i < 0 ? i : p; _; ) {
          if (m = _._prev, (_._act || N <= _._end) && _._ts && v !== _) {
            if (_.parent !== this)
              return this.render(i, n, s);
            if (_.render(_._ts > 0 ? (N - _._start) * _._ts : (_._dirty ? _.totalDuration() : _._tDur) + (N - _._start) * _._ts, n, s || Q && (_._initted || _._startAt)), p !== this._time || !this._ts && !y) {
              v = 0, m && (f += this._zTime = N ? -1e-8 : re);
              break;
            }
          }
          _ = m;
      ...
      if (v && !n && (this.pause(), v.render(p >= a ? 0 : -1e-8)._zTime = p >= a ? 1 : -1, this._ts))
        return this._start = C, qt(this), this.render(i, n, s);
      this._onUpdate && !n && me(this, "onUpdate", !0), (f === l && this._tTime >= this.totalDuration() || !f && a) && (C === this._start || Math.abs(w) !== Math.abs(this._ts)) && (this._lock || ((i || !u) && (f === l && this._ts > 0 || !f && this._ts < 0) && Ue(this, 1), !n && !(i < 0 && !a) && (f || a || !l) && (me(this, f === l && i >= 0 ? "onComplete" : "onReverseComplete", !0), this._prom && !(f < l && this.timeScale() > 0) && this._prom())));
    }
    return this;
  }, t.add = function(i, n) {
    var s = this;
    ...
    for (var l = [], u = this._first; u; )
      u._start >= a && (u instanceof H ? n && l.push(u) : (s && l.push(u), i && l.push.apply(l, u.getChildren(!0, n, s)))), u = u._next;
    return l;
    ...
    return K(i) ? this.removeLabel(i) : $(i) ? this.killTweensOf(i) : (i.parent === this && Zt(this, i), i === this._recent && (this._recent = this._last), Qe(this));
  }, t.totalTime = function(i, n) {
    return arguments.length ? (this._forcing = 1, !this._dp && this._ts && (this._start = J(pe.time - (this._ts > 0 ? i / this._ts : (this.totalDuration() - i) / -this._ts))), o.prototype.totalTime.call(this, i, n), this._forcing = 0, this) : this._tTime;
  }, t.addLabel = function(i, n) {
    return this.labels[i] = Ce(this, n), this;
  }, t.removeLabel = function(i) {
    return delete this.labels[i], this;
  }, t.addPause = function(i, n, s) {
    var a = H.delayedCall(0, n || St, s);
    ...
    for (var s = [], a = be(i), l = this._first, u = De(n), f; l; )
      l instanceof H ? Dn(l._targets, a) && (u ? (!Ve || l._initted && l._ts) && l.globalTime(0) <= n && l.globalTime(l.totalDuration()) > n : !n || l.isActive()) && s.push(l) : (f = l.getTweensOf(a, n)).length && s.push.apply(s, f), l = l._next;
    return s;
  }, t.tweenTo = function(i, n) {
    n = n || {};
    var s = this, a = Ce(s, i), l = n, u = l.startAt, f = l.onStart, d = l.onStartParams, p = l.immediateRender, _, m = H.to(s, ye({
      ease: n.ease || "none",
      lazy: !1,
      immediateRender: !1,
      time: a,
      ...
      onStart: function() {
        if (s.pause(), !_) {
          ...
          m._dur !== g && pt(m, g, 0, 1).render(m._time, !0, !0), _ = 1;
        }
        f && f.apply(m, d || []);
      }
    }, n));
    ...
    if (W._ts && (Mi(W, Ut(i, W)), Si = pe.frame), pe.frame >= ti) {
      ti += ge.autoSleep || 120;
      var n = W._first;
...
var ns = function(e, t, r, i, n, s, a) {
  var l = new ue(this._pt, e, t, 0, 1, sn, null, n), u = 0, f = 0, d, p, _, m, c, g, y, v;
  for (l.b = r, l.e = i, r += "", i += "", (y = ~i.indexOf("random(")) && (i = Pt(i)), s && (v = [r, i], s(v, e, t), r = v[0], i = v[1]), p = r.match(tr) || []; d = tr.exec(i); )
    m = d[0], c = i.substring(u, d.index), _ ? _ = (_ + 1) % 5 : c.substr(-5) === "rgba(" && (_ = 1), m !== p[f++] && (g = parseFloat(p[f - 1]) || 0, l._pt = {
      _next: l._pt,
      p: c || f === 1 ? c : ",",
  ...
  return l.c = u < i.length ? i.substring(u, i.length) : "", l.fp = a, (wi.test(i) || y) && (l.e = 0), this._pt = l, l;
}, Nr = function(e, t, r, i, n, s, a, l, u, f) {
  $(i) && (i = i(n || 0, e, s));
  var d = e[t], p = r !== "get" ? r : $(d) ? u ? e[t.indexOf("set") || !$(e["get" + t.substr(3)]) ? t : "get" + t.substr(3)](u) : e[t]() : d, _ = $(d) ? u ? us : rn : Lr, m;
  if (K(i) && (~i.indexOf("random(") && (i = Pt(i)), i.charAt(1) === "=" && (m = ut(p, i) + (te(p) || 0), (m || m === 0) && (i = m))), !f || p !== i || xr)
    return !isNaN(p * i) && i !== "" ? (m = new ue(this._pt, e, t, +p || 0, i - (p || 0), typeof d == "boolean" ? cs : nn, 0, _), u && (m.fp = u), a && m.modifier(a, this, e), this._pt = m) : (!d && !(t in e) && Sr(t, i), ns.call(this, e, t, p, i, _, l || ge.stringFilter, u));
  ...
  var i = e.vars, n = i.ease, s = i.startAt, a = i.immediateRender, l = i.lazy, u = i.onUpdate, f = i.runBackwards, d = i.yoyoEase, p = i.keyframes, _ = i.autoRevert, m = e._dur, c = e._startAt, g = e._targets, y = e.parent, v = y && y.data === "nested" ? y.vars.targets : g, w = e._overwrite === "auto" && !Tr, C = e.timeline, x, T, k, E, b, N, z, D, j, G, B, U, X;
  if (C && (!p || !n) && (n = "none"), e._ease = et(n, ht.ease), e._yEase = d ? qi(et(d === !0 ? n : d, ht.ease)) : 0, d && e._yoyo && !e._repeat && (d = e._yEase, e._yEase = e._ease, e._ease = d), e._from = !C && !!i.runBackwards, !C || p && !i.stagger) {
    if (D = g[0] ? Ke(g[0]).harness : 0, U = D && i[D.prop], x = Bt(i, Pr), c && (c._zTime < 0 && c.progress(1), t < 0 && f && a && !_ ? c.render(-1, !0) : c.revert(f && m ? Ft : An), c._lazy = 0), s) {
      if (Ue(e._startAt = H.set(g, ye({
        data: "isStart",
        overwrite: !1,
        parent: y,
        immediateRender: !0,
        ...
        stagger: 0
      }, s))), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && (Q || !a && !_) && e._startAt.revert(Ft), a && m && t <= 0 && r <= 0) {
        t && (e._zTime = t);
        return;
      }
    } else if (f && m && !c) {
      ...
      }, x), U && (k[D.prop] = U), Ue(e._startAt = H.set(g, k)), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && (Q ? e._startAt.revert(Ft) : e._startAt.render(-1, !0)), e._zTime = t, !a)
        o(e._startAt, re, re);
      else if (!t)
        return;
    }
    for (e._pt = e._ptCache = 0, l = m && oe(l) || l && !m, T = 0; T < g.length; T++) {
      if (b = g[T], z = b._gsap || Rr(g)[T]._gsap, e._ptLookup[T] = G = {}, hr[z.id] && Ye.length && Yt(), B = v === g ? T : v.indexOf(b), D && (j = new D()).init(b, U || x, e, B, v) !== !1 && (e._pt = E = new ue(e._pt, b, j.name, 0, 1, j.render, j, 0, j.priority), j._props.forEach(function(he) {
        G[he] = E;
      }), j.priority && (N = 1)), !D || U)
        for (k in x)
          _e[k] && (j = Qi(k, x, e, B, b, v)) ? j.priority && (N = 1) : G[k] = E = Nr.call(e, b, k, "get", x[k], B, v, 0, i.stringFilter);
      e._op && e._op[T] && e.kill(b, e._op[T]), w && e._pt && (Ve = e, W.killTweensOf(b, G, e.globalTime(t)), X = !e.parent, Ve = 0), e._pt && l && (hr[z.id] = 1);
    }
    N && an(e), e._onInit && e._onInit(e);
  }
  e._onUpdate = u, e._initted = (!e._op || e._pt) && !X, p && t <= 0 && C.render(Oe, !0, !0);
}, as = function(e, t, r, i, n, s, a, l) {
  var u = (e._pt && e._ptCache || (e._ptCache = {}))[t], f, d, p, _;
  if (!u)
    for (u = e._ptCache[t] = [], p = e._ptLookup, _ = e._targets.length; _--; ) {
      if (f = p[_][t], f && f.d && f.d._pt)
  ...
  for (_ = u.length; _--; )
    d = u[_], f = d._pt || d, f.s = (i || i === 0) && !n ? i : f.s + (i || 0) + s * f.c, f.c = r - f.s, d.e && (d.e = Z(r) + te(d.e)), d.b && (d.b = f.s + te(d.b));
}, os = function(e, t) {
...
var H = /* @__PURE__ */ function(o) {
  ...
  function e(r, i, n, s) {
    ...
    var l = a.vars, u = l.duration, f = l.delay, d = l.immediateRender, p = l.stagger, _ = l.overwrite, m = l.keyframes, c = l.defaults, g = l.scrollTrigger, y = l.yoyoEase, v = i.parent || W, w = (ie(r) || Ci(r) ? De(r[0]) : "length" in i) ? [r] : be(r), C, x, T, k, E, b, N, z;
    if (a._targets = w.length ? Rr(w) : Ot("GSAP target " + r + " not found. https://gsap.com", !ge.nullTargetWarn) || [], a._ptLookup = [], a._overwrite = _, m || p || zt(u) || zt(f)) {
      if (i = a.vars, C = a.timeline = new ae({
        data: "nested",
        defaults: c || {},
        targets: v && v.data === "nested" ? v.vars.targets : w
      }), C.kill(), C.parent = C._dp = Ae(a), C._start = 0, p || zt(u) || zt(f)) {
        if (k = w.length, N = p && Vi(p), Pe(p))
          for (E in p)
            ~en.indexOf(E) && (z || (z = {}), z[E] = p[E]);
        for (x = 0; x < k; x++)
          T = Bt(i, tn), T.stagger = 0, y && (T.yoyoEase = y), z && dt(T, z), b = w[x], T.duration = +Et(u, Ae(a), x, b, w), T.delay = (+Et(f, Ae(a), x, b, w) || 0) - a._delay, !p && k === 1 && T.delay && (a._delay = f = T.delay, a._start += f, T.delay = 0), C.to(b, T, N ? N(x, b, w) : 0), C._ease = R.none;
        C.duration() ? u = f = 0 : a.timeline = 0;
      } else if (m) {
        Tt(ye(C.vars.defaults, {
          ease: "none"
        ...
        if (ie(m))
          ...
          T = {};
          for (E in m)
            E === "ease" || E === "easeEach" || ls(E, m[E], T, m.easeEach);
          for (E in T)
            for (j = T[E].sort(function(U, X) {
              ...
              }, B[E] = G.v, C.to(w, B, D), D += B.duration;
          C.duration() < u && C.to({}, {
      ...
      a.timeline = 0;
    return _ === !0 && !Tr && (Ve = Ae(a), W.killTweensOf(w), Ve = 0), ke(v, Ae(a), n), i.reversed && a.reverse(), i.paused && a.paused(!0), (d || !u && !m && a._start === J(v._time) && oe(d) && Vn(Ae(a)) && v.data !== "nested") && (a._tTime = -1e-8, a.render(Math.max(0, -f) || 0)), g && Di(Ae(a), g), a;
  }
  var t = e.prototype;
  return t.render = function(i, n, s) {
    var a = this._time, l = this._tDur, u = this._dur, f = i < 0, d = i > l - re && !f ? l : i < re ? 0 : i, p, _, m, c, g, y, v, w, C;
    if (!u)
      Wn(this, i, n, s);
    else if (d !== this._tTime || !i || s || !this._initted && this._tTime || this._startAt && this._zTime < 0 !== f || this._lazy) {
      if (p = d, w = this.timeline, this._repeat) {
        if (c = u + this._rDelay, this._repeat < -1 && f)
          return this.totalTime(c * 100 + i, n, s);
        if (p = J(d % c), d === l ? (m = this._repeat, p = u) : (g = J(d / c), m = ~~g, m && m === g ? (p = u, m--) : p > u && (p = u)), y = this._yoyo && m & 1, y && (C = this._yEase, p = u - p), g = _t(this._tTime, c), p === a && !s && this._initted && m === g)
          return this._tTime = d, this;
        m !== g && (w && this._yEase && Hi(w, y), this.vars.repeatRefresh && !y && !this._lock && p !== c && this._initted && (this._lock = s = 1, this.render(J(c * m), !0).invalidate()._lock = 0));
      }
      if (!this._initted) {
        if (ji(this, f ? i : p, s, n, d))
      ...
      if (this._tTime = d, this._time = p, !this._act && this._ts && (this._act = 1, this._lazy = 0), this.ratio = v = (C || this._ease)(p / u), this._from && (this.ratio = v = 1 - v), p && !a && !n && !m && (me(this, "onStart"), this._tTime !== d))
        return this;
      for (_ = this._pt; _; )
        _.r(v, _.d), _ = _._next;
      w && w.render(i < 0 ? i : w._dur * w._ease(p / this._dur), n, s) || this._startAt && (this._zTime = i), this._onUpdate && !n && (f && dr(this, i, n, s), me(this, "onUpdate")), this._repeat && m !== g && this.vars.onRepeat && !n && this.parent && me(this, "onRepeat"), (d === this._tDur || !d) && this._tTime === d && (f && !this._onUpdate && dr(this, i, !0, !0), (i || !u) && (d === this._tDur && this._ts > 0 || !d && this._ts < 0) && Ue(this, 1), !n && !(f && !a) && (d || a || y) && (me(this, d === l ? "onComplete" : "onReverseComplete", !0), this._prom && !(d < l && this.timeScale() > 0) && this._prom()));
    }
    return this;
  }, t.targets = function() {
    ...
    return this._initted || Ar(this, u), f = this._ease(u / this._dur), as(this, i, n, s, a, f, u, l) ? this.resetTo(i, n, s, a, 1) : (Ht(this, 0), this.parent || Ai(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0));
  }, t.kill = function(i, n) {
    ...
    var a = this._targets, l = i ? be(i) : a, u = this._ptLookup, f = this._pt, d, p, _, m, c, g, y;
    if ((!n || n === "all") && zn(a, l))
    ...
    for (d = this._op = this._op || [], n !== "all" && (K(n) && (c = {}, le(n, function(v) {
      ...
      if (~l.indexOf(a[y])) {
        p = u[y], n === "all" ? (d[y] = n, m = p, _ = {}) : (_ = d[y] = d[y] || {}, m = n);
        for (c in m)
          g = p && p[c], g && ((!("kill" in g.d) || g.d.kill(c) === !0) && Zt(this, g, "_pt"), delete p[c]), _ !== "all" && (_[c] = 1);
      }
...
ge.stringFilter = Zi;
var tt = [], It = {}, ps = [], oi = 0, ms = 0, ar = function(e) {
  return (It[e] || ps).map(function(t) {
    return t();
  });
}, yr = function() {
  var e = Date.now(), t = [];
  ...
  return e.add = function(r, i, n) {
    ...
    return this.data.forEach(function(i) {
      return i instanceof o ? r.push.apply(r, i.getTweens()) : i instanceof H && !(i.parent && i.parent.data === "nested") && r.push(i);
    }), r;
  }, e.clear = function() {
    ...
    if (r ? function() {
      ...
      for (a.map(function(f) {
        ...
        u = n.data[l], u instanceof ae ? u.data !== "nested" && (u.scrollTrigger && u.scrollTrigger.revert(), u.kill()) : !(u instanceof H) && u.revert && u.revert(r);
  ...
  return e.add = function(r, i, n) {
    ...
    for (u in r)
      u === "all" ? f = 1 : (l = Te.matchMedia(r[u]), l && (tt.indexOf(s) < 0 && tt.push(s), (a[u] = l.matches) && (f = 1), l.addListener ? l.addListener(yr) : l.addEventListener("change", yr)));
  ...
  quickTo: function(e, t, r) {
    var i, n = ce.to(e, ye((i = {}, i[t] = "+=0.1", i.paused = !0, i.stagger = 0, i), r || {})), s = function(l, u, f) {
  ...
  exportRoot: function(e, t) {
    ...
    for (r.smoothChildTiming = oe(e.smoothChildTiming), W.remove(r), r._dp = 0, r._time = r._tTime = W._time, i = W._first; i; )
      n = i._next, (t || !(!i._dur && i instanceof H && i.vars.onComplete === i._targets[0])) && ke(r, i, i._start - i._delay), i = n;
    return ke(W, r, 0), r;
  },
...
}, or("roundProps", gr), or("modifiers"), or("snap", Ii)) || $t;
H.version = ae.version = ce.version = "3.12.7";
ki = 1;
Er() && mt();
R.Power0;
R.Power1;
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var li, Ie, ft, zr, Je, ui, Fr, vs = function() {
  return typeof window < "u";
  ...
  vs() && window.document && (li = window, Ie = li.document, ft = Ie.documentElement, Je = Cr("div") || {
    style: {}
  ...
  var n = parseFloat(r) || 0, s = (r + "").trim().substr((n + "").length) || "px", a = Je.style, l = Cs.test(t), u = e.tagName.toLowerCase() === "svg", f = (u ? "client" : "offset") + (l ? "Width" : "Height"), d = 100, p = i === "px", _ = i === "%", m, c, g, y;
  if (i === s || !n || _i[i] || _i[s])
    return n;
  if (s !== "px" && !p && (n = o(e, t, r, "px")), y = e.getCTM && _n(e), (_ || s === "%") && (je[t] || ~t.indexOf("adius")))
    return m = y ? e.getBBox()[l ? "width" : "height"] : e[f], Z(_ ? n / m * d : n / 100 * m);
  if (a[l ? "width" : "height"] = d + (p ? s : i), c = i !== "rem" && ~t.indexOf("adius") || i === "em" && e.appendChild && !u ? e : e.parentNode, y && (c = (e.ownerSVGElement || {}).parentNode), (!c || c === Ie || !c.appendChild) && (c = Ie.body), g = c._gsap, g && _ && g.width && l && g.time === pe.time && !g.uncache)
    return Z(n / g.width * d);
  if (_ && (t === "height" || t === "width")) {
    var v = e.style[t];
    e.style[t] = d + i, m = e[f], v ? e.style[t] = v : rt(e, t);
  } else
    (_ || s === "%") && !Ls[Se(c, "display")] && (a.position = Se(e, "position")), c === e && (a.position = "static"), c.appendChild(Je), m = Je[f], c.removeChild(Je), a.position = "absolute";
  return l && _ && (g = Ke(c), g.time = pe.time, g.width = c[f]), Z(p ? m * n / d : m && n ? d / m * n : 0);
}, Le = function(e, t, r, i) {
  var n;
  ...
  var a = new ue(this._pt, e.style, t, 0, 1, sn), l = 0, u = 0, f, d, p, _, m, c, g, y, v, w, C, x;
  if (a.b = r, a.e = i, r += "", i += "", i === "auto" && (c = e.style[t], e.style[t] = i, i = Se(e, t) || i, c ? e.style[t] = c : rt(e, t)), f = [r, i], Zi(f), r = f[0], i = f[1], p = r.match(ot) || [], x = i.match(ot) || [], x.length) {
    for (; d = ot.exec(i); )
      g = d[0], v = i.substring(l, d.index), m ? m = (m + 1) % 5 : (v.substr(-5) === "rgba(" || v.substr(-5) === "hsla(") && (m = 1), g !== (c = p[u++] || "") && (_ = parseFloat(c) || 0, C = c.substr((_ + "").length), g.charAt(1) === "=" && (g = ut(_, g) + C), y = parseFloat(g), w = g.substr((y + "").length), l = ot.lastIndex - w.length, w || (w = w || ge.units[t] || C, l === i.length && (i += w, a.e += w)), C !== w && (_ = $e(e, t, c, w) || 0), a._pt = {
        _next: a._pt,
        p: v || u === 1 ? v : ",",
        //note: SVG spec allows omission of comma/space when a negative sign is wedged between two numbers, like 2.5-5.3 instead of 2.5,-5.3 but when tweening, the negative value may switch to positive, so we insert the comma just in case.
        s: _,
  ...
  */
  ...
  var a = e._gsap, l = n || Ir(e, !0), u = a.xOrigin || 0, f = a.yOrigin || 0, d = a.xOffset || 0, p = a.yOffset || 0, _ = l[0], m = l[1], c = l[2], g = l[3], y = l[4], v = l[5], w = t.split(" "), C = parseFloat(w[0]) || 0, x = parseFloat(w[1]) || 0, T, k, E, b;
  r ? l !== Nt && (k = _ * g - m * c) && (E = C * (g / k) + x * (-c / k) + (c * v - g * y) / k, b = C * (-m / k) + x * (_ / k) - (_ * v - m * y) / k, C = E, x = b) : (T = dn(e), C = T.x + (~w[0].indexOf("%") ? C / 100 * T.width : C), x = T.y + (~(w[1] || w[0]).indexOf("%") ? x / 100 * T.height : x)), i || i !== !1 && a.smooth ? (y = C - u, v = x - f, a.xOffset = d + (y * _ + v * c) - y, a.yOffset = p + (y * m + v * g) - v) : a.xOffset = a.yOffset = 0, a.xOrigin = C, a.yOrigin = x, a.smooth = !!i, a.origin = t, a.originIsAbsolute = !!r, e.style[fe] = "0px 0px", s && (We(s, a, "xOrigin", u, C), We(s, a, "yOrigin", f, x), We(s, a, "xOffset", d, a.xOffset), We(s, a, "yOffset", p, a.yOffset)), e.setAttribute("data-svg-origin", C + " " + x);
}, At = function(e, t) {
  var r = e._gsap || new Ki(e);
  if ("x" in r && !t && !r.uncache)
    return r;
  var i = e.style, n = r.scaleX < 0, s = "px", a = "deg", l = getComputedStyle(e), u = Se(e, fe) || "0", f, d, p, _, m, c, g, y, v, w, C, x, T, k, E, b, N, z, D, j, G, B, U, X, he, ve, ze, de, Me, nt, ne, we;
  return f = d = p = c = g = y = v = w = C = 0, _ = m = 1, r.svg = !!(e.getCTM && _n(e)), l.translate && ((l.translate !== "none" || l.scale !== "none" || l.rotate !== "none") && (i[Y] = (l.translate !== "none" ? "translate3d(" + (l.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + (l.rotate !== "none" ? "rotate(" + l.rotate + ") " : "") + (l.scale !== "none" ? "scale(" + l.scale.split(" ").join(",") + ") " : "") + (l[Y] !== "none" ? l[Y] : "")), i.scale = i.rotate = i.translate = "none"), k = Ir(e, r.svg), r.svg && (r.uncache ? (he = e.getBBox(), u = r.xOrigin - he.x + "px " + (r.yOrigin - he.y) + "px", X = "") : X = !t && e.getAttribute("data-svg-origin"), wr(e, X || u, !!X || r.originIsAbsolute, r.smooth !== !1, k)), x = r.xOrigin || 0, T = r.yOrigin || 0, k !== Nt && (z = k[0], D = k[1], j = k[2], G = k[3], f = B = k[4], d = U = k[5], k.length === 6 ? (_ = Math.sqrt(z * z + D * D), m = Math.sqrt(G * G + j * j), c = z || D ? at(D, z) * He : 0, v = j || G ? at(j, G) * He + c : 0, v && (m *= Math.abs(Math.cos(v * ct))), r.svg && (f -= x - (x * z + T * j), d -= T - (x * D + T * G))) : (we = k[6], nt = k[7], ze = k[8], de = k[9], Me = k[10], ne = k[11], f = k[12], d = k[13], p = k[14], E = at(we, Me), g = E * He, E && (b = Math.cos(-E), N = Math.sin(-E), X = B * b + ze * N, he = U * b + de * N, ve = we * b + Me * N, ze = B * -N + ze * b, de = U * -N + de * b, Me = we * -N + Me * b, ne = nt * -N + ne * b, B = X, U = he, we = ve), E = at(-j, Me), y = E * He, E && (b = Math.cos(-E), N = Math.sin(-E), X = z * b - ze * N, he = D * b - de * N, ve = j * b - Me * N, ne = G * N + ne * b, z = X, D = he, j = ve), E = at(D, z), c = E * He, E && (b = Math.cos(E), N = Math.sin(E), X = z * b + D * N, he = B * b + U * N, D = D * b - z * N, U = U * b - B * N, z = X, B = he), g && Math.abs(g) + Math.abs(c) > 359.9 && (g = c = 0, y = 180 - y), _ = Z(Math.sqrt(z * z + D * D + j * j)), m = Z(Math.sqrt(U * U + we * we)), E = at(B, U), v = Math.abs(E) > 2e-4 ? E * He : 0, C = ne ? 1 / (ne < 0 ? -ne : ne) : 0), r.svg && (X = e.getAttribute("transform"), r.forceCSS = e.setAttribute("transform", "") || !mn(Se(e, Y)), X && e.setAttribute("transform", X))), Math.abs(v) > 90 && Math.abs(v) < 270 && (n ? (_ *= -1, v += c <= 0 ? 180 : -180, c += c <= 0 ? 180 : -180) : (m *= -1, v += v <= 0 ? 180 : -180)), t = t || r.uncache, r.x = f - ((r.xPercent = f && (!t && r.xPercent || (Math.round(e.offsetWidth / 2) === Math.round(-f) ? -50 : 0))) ? e.offsetWidth * r.xPercent / 100 : 0) + s, r.y = d - ((r.yPercent = d && (!t && r.yPercent || (Math.round(e.offsetHeight / 2) === Math.round(-d) ? -50 : 0))) ? e.offsetHeight * r.yPercent / 100 : 0) + s, r.z = p + s, r.scaleX = Z(_), r.scaleY = Z(m), r.rotation = Z(c) + a, r.rotationX = Z(g) + a, r.rotationY = Z(y) + a, r.skewX = v + a, r.skewY = w + a, r.transformPerspective = C + s, (r.zOrigin = parseFloat(u.split(" ")[2]) || !t && r.zOrigin || 0) && (i[fe] = Xt(u)), r.xOffset = r.yOffset = 0, r.force3D = ge.force3D, r.renderTransform = r.svg ? Vs : hn ? gn : Fs, r.uncache = 0, r;
}, Xt = function(e) {
  ...
  var r = t || this, i = r.xPercent, n = r.yPercent, s = r.x, a = r.y, l = r.z, u = r.rotation, f = r.rotationY, d = r.rotationX, p = r.skewX, _ = r.skewY, m = r.scaleX, c = r.scaleY, g = r.transformPerspective, y = r.force3D, v = r.target, w = r.zOrigin, C = "", x = y === "auto" && e && e !== 1 || y === !0;
  if (w && (d !== Ze || f !== Ze)) {
    var T = parseFloat(f) * ct, k = Math.sin(T), E = Math.cos(T), b;
    T = parseFloat(d) * ct, b = Math.cos(T), s = lr(v, s, k * b * -w), a = lr(v, a, -Math.sin(T) * -w), l = lr(v, l, E * b * -w + w);
  }
  g !== Ct && (C += "perspective(" + g + qe), (i || n) && (C += "translate(" + i + "%, " + n + "%) "), (x || s !== Ct || a !== Ct || l !== Ct) && (C += l !== Ct || x ? "translate3d(" + s + ", " + a + ", " + l + ") " : "translate(" + s + ", " + a + qe), u !== Ze && (C += "rotate(" + u + qe), f !== Ze && (C += "rotateY(" + f + qe), d !== Ze && (C += "rotateX(" + d + qe), (p !== Ze || _ !== Ze) && (C += "skew(" + p + ", " + _ + qe), (m !== 1 || c !== 1) && (C += "scale(" + m + ", " + c + qe), v.style[Y] = C || "translate(0, 0)";
}, Vs = function(e, t) {
  var r = t || this, i = r.xPercent, n = r.yPercent, s = r.x, a = r.y, l = r.rotation, u = r.skewX, f = r.skewY, d = r.scaleX, p = r.scaleY, _ = r.target, m = r.xOrigin, c = r.yOrigin, g = r.xOffset, y = r.yOffset, v = r.forceCSS, w = parseFloat(s), C = parseFloat(a), x, T, k, E, b;
  l = parseFloat(l), u = parseFloat(u), f = parseFloat(f), f && (f = parseFloat(f), u += f, l += f), l || u ? (l *= ct, u *= ct, x = Math.cos(l) * d, T = Math.sin(l) * d, k = Math.sin(l - u) * -p, E = Math.cos(l - u) * p, u && (f *= ct, b = Math.tan(u - f), b = Math.sqrt(1 + b * b), k *= b, E *= b, f && (b = Math.tan(f), b = Math.sqrt(1 + b * b), x *= b, T *= b)), x = Z(x), T = Z(T), k = Z(k), E = Z(E)) : (x = d, E = p, T = k = 0), (w && !~(s + "").indexOf("px") || C && !~(a + "").indexOf("px")) && (w = $e(_, "x", s, "px"), C = $e(_, "y", a, "px")), (m || c || g || y) && (w = Z(w + m - (m * x + c * k) + g), C = Z(C + c - (m * T + c * E) + y)), (i || n) && (b = _.getBBox(), w = Z(w + i / 100 * b.width), C = Z(C + n / 100 * b.height)), b = "matrix(" + x + "," + T + "," + k + "," + E + "," + w + "," + C + ")", _.setAttribute("transform", b), v && (_.style[Y] = b);
}, Is = function(e, t, r, i, n) {
  var s = 360, a = K(n), l = parseFloat(n) * (a && ~n.indexOf("rad") ? He : 1), u = l - i, f = i + u + "deg", d, p;
  return a && (d = n.split("_")[1], d === "short" && (u %= s, u !== u % (s / 2) && (u += u < 0 ? s : -360)), d === "cw" && u < 0 ? u = (u + s * fi) % s - ~~(u / s) * s : d === "ccw" && u > 0 && (u = (u - s * fi) % s - ~~(u / s) * s)), e._pt = p = new ue(e._pt, t, r, i, u, ws), p.e = f, p.u = "deg", e._props.push(r), p;
}, gi = function(e, t) {
  for (var r in t)
    e[r] = t[r];
  return e;
}, Ws = function(e, t, r) {
  var i = gi({}, r._gsap), n = "perspective,force3D,transformOrigin,svgOrigin", s = r.style, a, l, u, f, d, p, _, m;
  ...
  for (l in je)
    u = i[l], f = a[l], u !== f && n.indexOf(l) < 0 && (_ = te(u), m = te(f), d = _ !== m ? $e(r, l, u, m) : parseFloat(u), p = parseFloat(f), e._pt = new ue(e._pt, a, l, d, p - d, vr), e._pt.u = m || 0, e._props.push(l));
  gi(a, i);
};
le("padding,margin,Width,Radius", function(o, e) {
  ...
  Gt[e > 1 ? "border" + o : o] = function(a, l, u, f, d) {
    var p, _;
    if (arguments.length < 4)
      return p = s.map(function(m) {
        return Le(a, m, u);
      }), _ = p.join(" "), _.split(p[0]).length === 5 ? p[0] : _;
    p = (f + "").split(" "), _ = {}, s.forEach(function(m, c) {
      return _[m] = p[c] = p[c] || p[(c - 1) / 2 | 0];
    }), a.init(l, _, d);
  };
});
var xn = {
  ...
  init: function(e, t, r, i, n) {
    var s = this._props, a = e.style, l = r.vars.startAt, u, f, d, p, _, m, c, g, y, v, w, C, x, T, k, E;
    zr || br(), this.styles = this.styles || cn(e), E = this.styles.props, this.tween = r;
    for (c in t)
      if (c !== "autoRound" && (f = t[c], !(_e[c] && Qi(c, t, r, i, e, n)))) {
        if (_ = typeof f, m = Gt[c], _ === "function" && (f = f.call(r, i, e, n), _ = typeof f), _ === "string" && ~f.indexOf("random(") && (f = Pt(f)), m)
          m(this, e, c, f, r) && (k = 1);
        else if (c.substr(0, 2) === "--")
          u = (getComputedStyle(e).getPropertyValue(c) + "").trim(), f += "", Be.lastIndex = 0, Be.test(u) || (g = te(u), y = te(f)), y ? g !== y && (u = $e(e, c, u, y) + y) : g && (f += g), this.add(a, "setProperty", u, f, i, n, 0, 0, c), s.push(c), E.push(c, 0, a[c]);
        else if (_ !== "undefined") {
          if (l && c in l ? (u = typeof l[c] == "function" ? l[c].call(r, i, e, n) : l[c], K(u) && ~u.indexOf("random(") && (u = Pt(u)), te(u + "") || u === "auto" || (u += ge.units[c] || te(Le(e, c)) || ""), (u + "").charAt(1) === "=" && (u = Le(e, c))) : u = Le(e, c), p = parseFloat(u), v = _ === "string" && f.charAt(1) === "=" && f.substr(0, 2), v && (f = f.substr(2)), d = parseFloat(f), c in Ee && (c === "autoAlpha" && (p === 1 && Le(e, "visibility") === "hidden" && d && (p = 0), E.push("visibility", 0, a.visibility), We(this, a, "visibility", p ? "inherit" : "hidden", d ? "inherit" : "hidden", !d)), c !== "scale" && c !== "transform" && (c = Ee[c], ~c.indexOf(",") && (c = c.split(",")[0]))), w = c in je, w) {
            if (this.styles.save(c), C || (x = e._gsap, x.renderTransform && !t.parseTransform || At(e, t.parseTransform), T = t.smoothOrigin !== !1 && x.smooth, C = this._pt = new ue(this._pt, a, Y, 0, 1, x.renderTransform, x, 0, -1), C.dep = 1), c === "scale")
              this._pt = new ue(this._pt, x, "scaleY", x.scaleY, (v ? ut(x.scaleY, v + d) : d) - x.scaleY || 0, vr), this._pt.u = 0, s.push("scaleY", c), c += "X";
            else if (c === "transformOrigin") {
              E.push(fe, 0, a[fe]), f = js(f), x.svg ? wr(e, f, 0, T, 0, this) : (y = parseFloat(f.split(" ")[2]) || 0, y !== x.zOrigin && We(this, x, "zOrigin", x.zOrigin, y), We(this, a, c, Xt(u), Xt(f)));
              continue;
            } else if (c === "svgOrigin") {
              wr(e, f, 1, T, 0, this);
              continue;
            } else if (c in pn) {
              Is(this, x, c, p, v ? ut(p, v + f) : f);
              continue;
          ...
          if (w || (d || d === 0) && (p || p === 0) && !bs.test(f) && c in a)
            g = (u + "").substr((p + "").length), d || (d = 0), y = te(f) || (c in ge.units ? ge.units[c] : g), g !== y && (p = $e(e, c, u, y)), this._pt = new ue(this._pt, w ? x : a, c, p, (v ? ut(p, v + d) : d) - p, !w && (y === "px" || c === "zIndex") && t.autoRound !== !1 ? ks : vr), this._pt.u = y || 0, g !== y && y !== "%" && (this._pt.b = u, this._pt.r = Ts);
          else if (c in a)
          ...
          w || (c in a ? E.push(c, 0, a[c]) : typeof e[c] == "function" ? E.push(c, 2, e[c]()) : E.push(c, 1, u || e[c])), s.push(c);
        }
      }
    k && an(this);
  },
...
const qs = ({
  ...
  const n = er(null), s = er(
    q.timeline({ paused: !0, yoyo: !0, repeat: 0 })
  ), a = er(
    q.timeline({
      onReverseComplete: () => {
        r && q.to(n.current, { opacity: 0 }), i && i();
      }
    })
  );
  Cn(() => {
    const _ = q.utils.selector(n.current), m = _(".stroke-fng");
    a.current.from(_(".corner-left-bot"), {
      x: 20,
      y: -22,
      scale: 0.2,
      duration: 0.1,
      ...
      duration: 0.1,
      ease: "power2.out"
    }).from(m, { scale: 0, duration: 0.5, ease: "power2.out" });
  }, []);
  const l = (_) => (s.current.clear(), s.current.to(_(".corner-left-bot"), { x: -10, y: 5, duration: 0.05 }).to(_(".edge-triangle-left"), { x: -10, duration: 0.05 }).to(_(".corner-left-top"), { x: -10, y: -5, duration: 0.05 }).to(_(".edge-triangle-top"), { y: -5, duration: 0.05 }).to(_(".corner-right-top"), { x: 10, y: -5, duration: 0.05 }).to(_(".edge-triangle-right"), { x: 10, duration: 0.05 }).to(_(".corner-right-bot"), { x: 10, y: 5, duration: 0.05 }).to(_(".edge-triangle-bot"), { y: 5, duration: 0.05 }).to(_("text"), {
    opacity: 1,
    duration: 1,
    ease: "power1.in"
  }).to(_(".scanner"), {
    ...
    if (!n.current || a.current.reversed()) return;
    const _ = q.utils.selector(n.current), m = _(".stroke-fng");
    u(m), l(_), a.current.isActive() ? q.delayedCall(a.current.duration() - a.current.time(), () => {
      s.current.play();
    }) : s.current.play();
  }, d = () => {
    if (!n.current || a.current.reversed()) return;
    const _ = q.utils.selector(n.current), m = _(".stroke-fng"), c = () => {
      s.current.reverse(), q.killTweensOf(m), u(m, !0), q.killTweensOf(_(".scanner")), q.set(_(".scanner"), { y: 0, opacity: 0 });
    };
    a.current.isActive() ? q.delayedCall(a.current.duration() - a.current.time(), () => {
      c();
    }) : c();
  }, p = (_) => {
    if (a.current.isActive()) return;
    const m = q.utils.selector(n.current);
    r ? (q.killTweensOf(m(".scanner")), s.current.kill(), q.set(m(".scanner"), { y: 0, opacity: 0 }), q.set(m(".text"), { opacity: 0 }), a.current.reverse()) : q.to(n.current, {
      scale: 1.1,
      duration: 0.05,
      repeat: 1,
      yoyo: !0,
  ...
  return /* @__PURE__ */ P.jsx(
    "button",
    {
      ...
      children: /* @__PURE__ */ P.jsx(On, { ref: n })
    }
  );
}, Ys = ({
  rowsCount: o,
