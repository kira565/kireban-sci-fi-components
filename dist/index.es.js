...
const Ge = ({
  ...
  return `${i}${d}`;
}, [a]), Pe = ({ title: a, sciFiCode: u, isActive: c }) => {
  const i = Ve(u);
...
}, ze = ({ options: a, width: u = "w-full" }) => /* @__PURE__ */ o.jsx("div", { className: `flex flex-col gap-2 ${u}`, children: a.map((c, i) => /* @__PURE__ */ Oe(Pe, { ...c, key: i, sciFiCode: i })) }), pe = () => /* @__PURE__ */ o.jsxs("div", { className: "w-[150px] h-[50px] flex flex-row align-top gap-[2px]", children: [
  ...
  /* @__PURE__ */ o.jsx("div", { className: "h-[4px] w-[7px] artifact-border self-end rounded-none glowedGray bg-white ml-5" })
] }), Je = ({ children: a }) => /* @__PURE__ */ o.jsxs("div", { className: "relative flex flex-col min-h-screen bg-gray-100 dark:bg-darkGrayBg theme-text font-[RobotoCondensed] ", children: [
  /* @__PURE__ */ o.jsxs("div", { className: "sticky top-0 bg-gray-100 dark:bg-darkGrayBg w-full shadow-md z-10 flex gap-2 items-center border-b-evaTextDanger glowed-border-b", children: [
    /* @__PURE__ */ o.jsx("div", { className: "ml-2 mt-2 hidden md:block z-10", children: /* @__PURE__ */ o.jsx($e, { tilesPerRowCount: 2, rowsCount: 2 }) }),
    /* @__PURE__ */ o.jsx(
      "div",
      {
