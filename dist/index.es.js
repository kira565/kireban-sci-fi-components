  ...
  return q9(() => {
    const s = new ResizeObserver((a) => {
      for (const o of a) {
        ...
        let u;
        f < 300 ? u = { text: 4, header: 10 } : f >= 300 && f < 600 ? u = { text: 5, header: 18 } : f >= 600 && f < 900 ? u = { text: 10, header: 32 } : u = { text: 12, header: 38 }, n(u);
      }
    });
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ x.jsx("div", { className: "flex flex-col justify-center max-w-[4%] min-w-[10px]", children: /* @__PURE__ */ x.jsx(Gr, {}) }),
