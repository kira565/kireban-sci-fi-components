...
import Pt, { useMemo as Ot, createElement as Wt, useRef as it } from "react";
          ...
          DetermineComponentFrameRoot: function() {
            try {
              if (m) {
                ...
                (ne = l()) && typeof ne.catch == "function" && ne.catch(function() {
                });
              }
            } catch (K) {
...
` + Z[P].replace(
                    ...
                    return l.displayName && ge.includes("<anonymous>") && (ge = ge.replace("<anonymous>", l.displayName)), typeof l == "function" && Ze.set(l, ge), ge;
                  }
                while (1 <= P && 0 <= E);
              break;
            }
      ...
      return Z = (Z = l ? l.displayName || l.name : "") ? s(Z) : "", typeof l == "function" && Ze.set(l, Z), Z;
    }
    function f(l) {
      if (l == null) return "";
      if (typeof l == "function") {
    ...
    function h() {
      var l = o(this.type);
      return rt[l] || (rt[l] = !0, console.error(
    ...
    function x(l, m, C, S, Y, P) {
      if (typeof l == "string" || typeof l == "function" || l === N || l === A || l === R || l === G || l === V || l === I || typeof l == "object" && l !== null && (l.$$typeof === z || l.$$typeof === J || l.$$typeof === O || l.$$typeof === k || l.$$typeof === W || l.$$typeof === we || l.getModuleId !== void 0)) {
        var E = m.children;
        if (E !== void 0)
          if (S)
            if (D(E)) {
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
    ...
    function p(l, m) {
      if (typeof l == "object" && l && l.$$typeof !== At) {
        if (D(l))
        ...
        else if (l === null || typeof l != "object" ? C = null : (C = oe && l[oe] || l["@@iterator"], C = typeof C == "function" ? C : null), typeof C == "function" && C !== l.entries && (C = C.call(l), C !== l))
          for (; !(l = C.next()).done; )
    ...
    function y(l, m) {
      if (l._store && !l._store.validated && l.key == null && (l._store.validated = 1, m = w(m), !ot[m])) {
        ot[m] = !0;
        var C = "";
        l && l._owner != null && l._owner !== a() && (C = null, typeof l._owner.tag == "number" ? C = o(l._owner.type) : typeof l._owner.name == "string" && (C = l._owner.name), C = " It was passed a child from " + C + ".");
...
Check the top-level render call using <` + l + ">."), m;
    ...
    me.Fragment = N, me.jsx = function(l, m, C, S, Y) {
      return x(l, m, C, !1, S, Y);
    }, me.jsxs = function(l, m, C, S, Y) {
...
const Lr = ({
  ...
  function r() {
    return Array(o).fill(null).map((n, i) => /* @__PURE__ */ v.jsx("div", { className: "hex-row rotate-method", children: Array(e).fill(null).map((s, c) => /* @__PURE__ */ v.jsx("div", { className: `hex ${t ? "animation-active" : ""}` }, c)) }, i));
  }
  return /* @__PURE__ */ v.jsx("div", { className: "piece rotateMethod", children: r() });
}, Gt = (o) => Ot(() => {
  const e = (i, s) => {
    const c = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
    return c[(i + s) % c.length];
...
}, Mr = ({ options: o, width: e = "w-full" }) => /* @__PURE__ */ v.jsx("div", { className: `flex flex-col gap-2 ${e}`, children: o.map((t, r) => /* @__PURE__ */ Wt(zt, { ...t, key: r, sciFiCode: r })) }), ct = () => /* @__PURE__ */ v.jsxs("div", { className: "w-[150px] h-[50px] flex flex-row align-top gap-[2px]", children: [
...
*/
var Dt = /[achlmqstvz]|(-?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/ig, Ut = /(?:(-)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/ig, Xt = /[\+\-]?\d*\.?\d+e[\+\-]?\d+/ig, It = /(^[#\.][a-z]|[a-y][a-z])/i, Ft = Math.PI / 180, Ht = 180 / Math.PI, Se = Math.sin, Me = Math.cos, X = Math.abs, te = Math.sqrt, qt = Math.atan2, Ue = 1e8, ft = function(e) {
  return typeof e == "string";
}, vt = function(e) {
  return typeof e == "number";
}, Jt = function(e) {
  return typeof e > "u";
}, Qt = {}, Kt = {}, Pe = 1e5, bt = function(e) {
...
function Re(o) {
  o = ft(o) && It.test(o) && document.querySelector(o) || o;
...
function lr(o, e) {
  var t = o.tagName.toLowerCase(), r = 0.552284749831, n, i, s, c, f, a, d, u, h, g, x, p, b, y, w, _, T, j, N, R, A, k;
  return t === "path" || !o.getBBox ? o : (a = or(o, "x,y,width,height,cx,cy,rx,ry,r,x1,x2,y1,y2,points"), k = ar(o, ir[t]), t === "rect" ? (c = k.rx, f = k.ry || c, i = k.x, s = k.y, g = k.width - c * 2, x = k.height - f * 2, c || f ? (p = i + c * (1 - r), b = i + c, y = b + g, w = y + c * r, _ = y + c, T = s + f * (1 - r), j = s + f, N = j + x, R = N + f * r, A = N + f, n = "M" + _ + "," + j + " V" + N + " C" + [_, R, w, A, y, A, y - (y - b) / 3, A, b + (y - b) / 3, A, b, A, p, A, i, R, i, N, i, N - (N - j) / 3, i, j + (N - j) / 3, i, j, i, T, p, s, b, s, b + (y - b) / 3, s, y - (y - b) / 3, s, y, s, w, s, _, T, _, j].join(",") + "z") : n = "M" + (i + g) + "," + s + " v" + x + " h" + -g + " v" + -x + " h" + g + "z") : t === "circle" || t === "ellipse" ? (t === "circle" ? (c = f = k.r, u = c * r) : (c = k.rx, f = k.ry, u = f * r), i = k.cx, s = k.cy, d = c * r, n = "M" + (i + c) + "," + s + " C" + [i + c, s + u, i + d, s + f, i, s + f, i - d, s + f, i - c, s + u, i - c, s, i - c, s - u, i - d, s - f, i, s - f, i + d, s - f, i + c, s - u, i + c, s].join(",") + "z") : t === "line" ? n = "M" + k.x1 + "," + k.y1 + " L" + k.x2 + "," + k.y2 : (t === "polyline" || t === "polygon") && (h = (o.getAttribute("points") + "").match(Ut) || [], i = h.shift(), s = h.shift(), n = "M" + i + "," + s + " L" + h.join(","), t === "polygon" && (n += "," + i + "," + s + "z")), a.setAttribute("d", Et(a._gsRawPath = Oe(n))), e && o.parentNode && (o.parentNode.insertBefore(a, o), o.parentNode.removeChild(o)), a);
}
function _t(o, e, t) {
  var r = o[e], n = o[e + 2], i = o[e + 4], s;
  return r += (n - r) * t, n += (i - n) * t, r += (n - r) * t, s = n + (i + (o[e + 6] - i) * t - n) * t - r, r = o[e + 1], n = o[e + 3], i = o[e + 5], r += (n - r) * t, n += (i - n) * t, r += (n - r) * t, M(qt(n + (i + (o[e + 7] - i) * t - n) * t - r, s) * Ht);
}
function wt(o, e, t) {
  t = Jt(t) ? 1 : ut(t) || 0, e = ut(e) || 0;
  ...
  n.totalLength || le(n);
  var s = t > 1, c = pt(n, e, Qt, !0), f = pt(n, t, Kt), a = f.segment, d = c.segment, u = f.segIndex, h = c.segIndex, g = f.i, x = c.i, p = h === u, b = g === x && p, y, w, _, T, j, N, R, A;
  if (s || r) {
    for (y = u < h || p && g < x || b && f.t < c.t, dt(n, h, x, c.t) && (h++, y || (u++, b ? (f.t = (f.t - c.t) / (1 - c.t), g = 0) : p && (g -= x))), Math.abs(1 - (t - e)) < 1e-5 ? u = h - 1 : !f.t && u ? u-- : dt(n, u, g, f.t) && y && h++, c.t === 1 && (h = (h + 1) % n.length), j = [], N = n.length, R = 1 + N * r, A = h, R += (N - h + u) % N, T = 0; T < R; T++)
      tr(j, n[A++ % N]);
    n = j;
  } else if (_ = f.t === 1 ? 6 : Xe(a, g, f.t), e !== t)
    for (w = Xe(d, x, b ? c.t / f.t : c.t), p && (_ += w), a.splice(g + _ + 2), (w || x) && d.splice(0, x + w), T = n.length; T--; )
      (T < h || T > u) && n.splice(T, 1);
  else
    a.angle = _t(a, g + _, 0), g += _, c = a[g], f = a[g + 1], a.length = a.totalLength = 0, a.totalPoints = n.totalPoints = 8, a.push(c, f, c, f, c, f, c, f);
  return n.totalLength = 0, n;
}
function sr(o, e, t) {
  e = e || 0, o.samples || (o.samples = [], o.lookup = []);
  var r = ~~o.resolution || 12, n = 1 / r, i = o.length, s = o[e], c = o[e + 1], f = e ? e / 6 * r : 0, a = o.samples, d = o.lookup, u = (e ? o.minLength : Ue) || Ue, h = a[f + t * r - 1], g = e ? a[f - 1] : 0, x, p, b, y, w, _, T, j, N, R, A, k, O, W, G, V, J;
  for (a.length = d.length = 0, p = e + 2; p < i; p += 6) {
    if (b = o[p + 4] - s, y = o[p + 2] - s, w = o[p] - s, j = o[p + 5] - c, N = o[p + 3] - c, R = o[p + 1] - c, _ = T = A = k = 0, X(b) < 0.01 && X(j) < 0.01 && X(w) + X(R) < 0.01)
      o.length > 8 && (o.splice(p, 6), p -= 6, i -= 6);
    else
      for (x = 1; x <= r; x++)
        W = n * x, O = 1 - W, _ = T - (T = (W * W * b + 3 * O * (W * y + O * w)) * W), A = k - (k = (W * W * j + 3 * O * (W * N + O * R)) * W), V = te(A * A + _ * _), V < u && (u = V), g += V, a[f++] = g;
    s += b, c += j;
  }
  if (h)
    for (h -= g; f < a.length; f++)
      a[f] += h;
  if (a.length && u) {
    if (o.totalLength = J = a[a.length - 1] || 0, o.minLength = u, J / u < 9999)
      for (V = G = 0, x = 0; x < J; x += u)
        d[V++] = a[G] < x ? ++G : G;
  } else
    o.totalLength = a[0] = 0;
  return e ? g - a[e / 2 - 1] : g;
}
function le(o, e) {
  var t, r, n;
...
function Xe(o, e, t) {
  if (t <= 0 || t >= 1)
    return 0;
  var r = o[e], n = o[e + 1], i = o[e + 2], s = o[e + 3], c = o[e + 4], f = o[e + 5], a = o[e + 6], d = o[e + 7], u = r + (i - r) * t, h = i + (c - i) * t, g = n + (s - n) * t, x = s + (f - s) * t, p = u + (h - u) * t, b = g + (x - g) * t, y = c + (a - c) * t, w = f + (d - f) * t;
  ...
  if (!e)
    ...
    if (o.length > 1) {
      for (f = o.totalLength * e, d = u = 0; (d += o[u++].totalLength) < f; )
        n = u;
      i = o[n], a = d - i.totalLength, e = (f - a) / (d - a) || 0;
    }
    s = i.samples, c = i.resolution, f = i.totalLength * e, u = i.lookup.length ? i.lookup[~~(f / i.minLength)] || 0 : yt(s, f, e), a = u ? s[u - 1] : 0, d = s[u], d < f && (a = d, d = s[++u]), h = 1 / c * ((f - a) / (d - a) + u % c), u = ~~(u / c) * 6, r && h === 1 && (u + 6 < i.length ? (u += 6, h = 0) : n + 1 < o.length && (u = h = 0, i = o[++n]));
  }
  return t.t = h, t.i = u, t.path = o, t.segment = i, t.segIndex = n, t;
}
function gt(o, e, t, r) {
  var n = o[0], i = r || {}, s, c, f, a, d, u, h, g, x;
  if ((e < 0 || e > 1) && (e = bt(e)), n.lookup || le(o), o.length > 1) {
    for (f = o.totalLength * e, d = u = 0; (d += o[u++].totalLength) < f; )
      n = o[u];
    a = d - n.totalLength, e = (f - a) / (d - a) || 0;
  }
  return s = n.samples, c = n.resolution, f = n.totalLength * e, u = n.lookup.length ? n.lookup[e < 1 ? ~~(f / n.minLength) : n.lookup.length - 1] || 0 : yt(s, f, e), a = u ? s[u - 1] : 0, d = s[u], d < f && (a = d, d = s[++u]), h = 1 / c * ((f - a) / (d - a) + u % c) || 0, x = 1 - h, u = ~~(u / c) * 6, g = n[u], i.x = M((h * h * (n[u + 6] - g) + 3 * x * (h * (n[u + 4] - g) + x * (n[u + 2] - g))) * h + g), i.y = M((h * h * (n[u + 7] - (g = n[u + 1])) + 3 * x * (h * (n[u + 5] - g) + x * (n[u + 3] - g))) * h + g), t && (i.angle = n.totalLength ? _t(n, u, h >= 1 ? 1 - 1e-9 : h || 1e-9) : n.angle || 0), i;
}
function ve(o, e, t, r, n, i, s) {
  for (var c = o.length, f, a, d, u, h; --c > -1; )
    for (f = o[c], a = f.length, d = 0; d < a; d += 2)
      u = f[d], h = f[d + 1], f[d] = u * e + h * r + i, f[d + 1] = u * t + h * n + s;
  return o._dirty = 1, o;
}
function cr(o, e, t, r, n, i, s, c, f) {
  if (!(o === c && e === f)) {
    t = X(t), r = X(r);
    var a = n % 360 * Ft, d = Me(a), u = Se(a), h = Math.PI, g = h * 2, x = (o - c) / 2, p = (e - f) / 2, b = d * x + u * p, y = -u * x + d * p, w = b * b, _ = y * y, T = w / (t * t) + _ / (r * r);
    T > 1 && (t = te(T) * t, r = te(T) * r);
    var j = t * t, N = r * r, R = (j * N - j * _ - N * w) / (j * _ + N * w);
    R < 0 && (R = 0);
    var A = (i === s ? -1 : 1) * te(R), k = A * (t * y / r), O = A * -(r * b / t), W = (o + c) / 2, G = (e + f) / 2, V = W + (d * k - u * O), J = G + (u * k + d * O), z = (b - k) / t, I = (y - O) / r, oe = (-b - k) / t, ce = (-y - O) / r, H = z * z + I * I, pe = (I < 0 ? -1 : 1) * Math.acos(z / te(H)), $ = (z * ce - I * oe < 0 ? -1 : 1) * Math.acos((z * oe + I * ce) / te(H * (oe * oe + ce * ce)));
...
function Oe(o) {
  ...
  }).match(Dt) || [], t = [], r = 0, n = 0, i = 2 / 3, s = e.length, c = 0, f = "ERROR: malformed path: " + o, a, d, u, h, g, x, p, b, y, w, _, T, j, N, R, A = function(O, W, G, V) {
    w = (G - O) / 3, _ = (V - W) / 3, p.push(O + w, W + _, G - w, V - _, G, V);
  };
  if (!o || !isNaN(e[0]) || isNaN(e[1]))
    return console.log(f), t;
  for (a = 0; a < s; a++)
    if (j = g, isNaN(e[a]) ? (g = e[a].toUpperCase(), x = g !== e[a]) : a--, u = +e[a + 1], h = +e[a + 2], x && (u += r, h += n), a || (b = u, y = h), g === "M")
      p && (p.length < 8 ? t.length -= 1 : c += p.length), r = b = u, n = y = h, p = [u, h], t.push(p), a += 2, g = "L";
    else if (g === "C")
      p || (p = [0, 0]), x || (r = n = 0), p.push(u, h, r + e[a + 3] * 1, n + e[a + 4] * 1, r += e[a + 5] * 1, n += e[a + 6] * 1), a += 6;
    else if (g === "S")
      w = r, _ = n, (j === "C" || j === "S") && (w += r - p[p.length - 4], _ += n - p[p.length - 3]), x || (r = n = 0), p.push(w, _, u, h, r += e[a + 3] * 1, n += e[a + 4] * 1), a += 4;
    else if (g === "Q")
      w = r + (u - r) * i, _ = n + (h - n) * i, x || (r = n = 0), r += e[a + 3] * 1, n += e[a + 4] * 1, p.push(w, _, r + (u - r) * i, n + (h - n) * i, r, n), a += 4;
    else if (g === "T")
      w = r - p[p.length - 4], _ = n - p[p.length - 3], p.push(r + w, n + _, u + (r + w * 1.5 - u) * i, h + (n + _ * 1.5 - h) * i, r = u, n = h), a += 2;
    else if (g === "H")
      A(r, n, r = u, n), a += 1;
    else if (g === "V")
      A(r, n, r, n = u + (x ? n - r : 0)), a += 1;
    else if (g === "L" || g === "Z")
      g === "Z" && (u = b, h = y, p.closed = !0), (g === "L" || X(r - u) > 0.5 || X(n - h) > 0.5) && (A(r, n, u, h), g === "L" && (a += 2)), r = u, n = h;
    else if (g === "A") {
      if (N = e[a + 4], R = e[a + 5], w = e[a + 6], _ = e[a + 7], d = 7, N.length > 1 && (N.length < 3 ? (_ = w, w = R, d--) : (_ = R, w = N.substr(2), d -= 2), R = N.charAt(1), N = N.charAt(0)), T = cr(r, n, +e[a + 1], +e[a + 2], +e[a + 3], +N, +R, (x ? r : 0) + w * 1, (x ? n : 0) + _ * 1), a += d, T)
        for (d = 0; d < T.length; d++)
          p.push(T[d]);
      r = p[p.length - 2], n = p[p.length - 1];
    } else
      console.log(f);
  return a = p.length, a < 6 ? (t.pop(), a = 0) : p[0] === p[a - 2] && p[1] === p[a - 1] && (p.closed = !0), t.totalPoints = c + a, t;
}
function fr(o, e) {
  e === void 0 && (e = 1);
...
function Ie(o, e) {
  ...
  var t = o.length - 2, r = +o[0], n = +o[1], i = +o[2], s = +o[3], c = [r, n, r, n], f = i - r, a = s - n, d = Math.abs(o[t] - r) < 1e-3 && Math.abs(o[t + 1] - n) < 1e-3, u, h, g, x, p, b, y, w, _, T, j, N, R, A, k;
  for (d && (o.push(i, s), i = r, s = n, r = o[t - 2], n = o[t - 1], o.unshift(r, n), t += 4), e = e || e === 0 ? +e : 1, g = 2; g < t; g += 2)
    u = r, h = n, r = i, n = s, i = +o[g + 2], s = +o[g + 3], !(r === i && n === s) && (x = f, p = a, f = i - r, a = s - n, b = te(x * x + p * p), y = te(f * f + a * a), w = te(Math.pow(f / y + x / b, 2) + Math.pow(a / y + p / b, 2)), _ = (b + y) * e * 0.25 / w, T = r - (r - u) * (b ? _ / b : 0), j = r + (i - r) * (y ? _ / y : 0), N = r - (T + ((j - T) * (b * 3 / (b + y) + 0.5) / 4 || 0)), R = n - (n - h) * (b ? _ / b : 0), A = n + (s - n) * (y ? _ / y : 0), k = n - (R + ((A - R) * (b * 3 / (b + y) + 0.5) / 4 || 0)), (r !== u || n !== h) && c.push(
      M(T + N),
      // first control point
      M(R + k),
      M(r),
  ...
  return r !== i || n !== s || c.length < 4 ? c.push(M(i), M(s), M(i), M(s)) : c.length -= 2, c.length === 2 ? c.push(r, n, r, n, r, n) : d && (c.splice(0, 6), c.length = c.length - 6), c;
}
function Et(o) {
  vt(o[0]) && (o = [o]);
...
var re, se, Je, Ve, be, Ae, We, ye, F = "transform", Fe = F + "Origin", Nt, kt = function(e) {
  ...
  if (e.parentNode && (re || kt(e))) {
    var r = Qe(e), n = r ? r.getAttribute("xmlns") || "http://www.w3.org/2000/svg" : "http://www.w3.org/1999/xhtml", i = r ? t ? "rect" : "g" : "div", s = t !== 2 ? 0 : 100, c = t === 3 ? 100 : 0, f = "position:absolute;display:block;pointer-events:none;margin:0;padding:0;", a = re.createElementNS ? re.createElementNS(n.replace(/^https/, "http"), i) : re.createElement(i);
    return t && (r ? (Ae || (Ae = o(e)), a.setAttribute("width", 0.01), a.setAttribute("height", 0.01), a.setAttribute("transform", "translate(" + s + "," + c + ")"), Ae.appendChild(a)) : (be || (be = o(e), be.style.cssText = f), a.style.cssText = f + "width:0.1px;height:0.1px;top:" + c + "px;left:" + s + "px", be.appendChild(a))), a;
  }
  ...
  var r = Qe(e), n = e === r, i = r ? Tt : Lt, s = e.parentNode, c, f, a, d, u, h;
  if (e === se)
    return e;
  if (i.length || i.push(Ge(e, 1), Ge(e, 2), Ge(e, 3)), c = r ? Ae : be, r)
    n ? (a = xr(e), d = -a.e / a.a, u = -a.f / a.d, f = We) : e.getBBox ? (a = e.getBBox(), f = e.transform ? e.transform.baseVal : {}, f = f.numberOfItems ? f.numberOfItems > 1 ? gr(f) : f.getItem(0).matrix : We, d = f.a * a.x + f.c * a.y, u = f.b * a.x + f.d * a.y) : (f = new _e(), d = u = 0), t && e.tagName.toLowerCase() === "g" && (d = u = 0), (n ? r : s).appendChild(c), c.setAttribute("transform", "matrix(" + f.a + "," + f.b + "," + f.c + "," + f.d + "," + (f.e + d) + "," + (f.f + u) + ")");
  else {
    if (d = u = 0, Nt)
      for (f = e.offsetParent, a = e; a && (a = a.parentNode) && a !== f && a.parentNode; )
        (se.getComputedStyle(a)[F] + "").length > 4 && (d = a.offsetLeft, u = a.offsetTop, a = 0);
    if (h = se.getComputedStyle(e), h.position !== "absolute" && h.position !== "fixed")
      for (f = e.offsetParent; s && s !== f; )
        d += s.scrollLeft || 0, u += s.scrollTop || 0, s = s.parentNode;
    a = c.style, a.top = e.offsetTop - u + "px", a.left = e.offsetLeft - d + "px", a[F] = h[F], a[Fe] = h[Fe], a.position = h.position === "fixed" ? "fixed" : "absolute", e.parentNode.appendChild(c);
  }
  return c;
}, ze = function(e, t, r, n, i, s, c) {
  return e.a = t, e.b = r, e.c = n, e.d = i, e.e = s, e.f = c, e;
}, _e = /* @__PURE__ */ function() {
  function o(t, r, n, i, s, c) {
    t === void 0 && (t = 1), r === void 0 && (r = 0), n === void 0 && (n = 0), i === void 0 && (i = 1), s === void 0 && (s = 0), c === void 0 && (c = 0), ze(this, t, r, n, i, s, c);
  }
  var e = o.prototype;
  return e.inverse = function() {
    var r = this.a, n = this.b, i = this.c, s = this.d, c = this.e, f = this.f, a = r * s - n * i || 1e-10;
    return ze(this, s / a, -n / a, -i / a, r / a, (i * f - s * c) / a, -(r * f - n * c) / a);
  }, e.multiply = function(r) {
    var n = this.a, i = this.b, s = this.c, c = this.d, f = this.e, a = this.f, d = r.a, u = r.c, h = r.b, g = r.d, x = r.e, p = r.f;
    return ze(this, d * n + h * s, d * i + h * c, u * n + g * s, u * i + g * c, f + x * n + p * s, a + x * i + p * c);
  }, e.clone = function() {
    return new o(this.a, this.b, this.c, this.d, this.e, this.f);
  }, e.equals = function(r) {
    var n = this.a, i = this.b, s = this.c, c = this.d, f = this.e, a = this.f;
    return n === r.a && i === r.b && s === r.c && c === r.d && f === r.e && a === r.f;
  }, e.apply = function(r, n) {
    n === void 0 && (n = {});
    var i = r.x, s = r.y, c = this.a, f = this.b, a = this.c, d = this.d, u = this.e, h = this.f;
    return n.x = i * c + s * a + u || 0, n.y = i * f + s * d + h || 0, n;
  }, o;
}();
function he(o, e, t, r) {
  if (!o || !o.parentNode || (re || kt(o)).documentElement === o)
    return new _e();
  var n = ur(o), i = Qe(o), s = i ? Tt : Lt, c = mr(o, t), f = s[0].getBoundingClientRect(), a = s[1].getBoundingClientRect(), d = s[2].getBoundingClientRect(), u = c.parentNode, h = !r && pr(o), g = new _e((a.left - f.left) / 100, (a.top - f.top) / 100, (d.left - f.left) / 100, (d.top - f.top) / 100, f.left + (h ? 0 : hr()), f.top + (h ? 0 : dr()));
  if (u.removeChild(c), n)
    for (f = n.length; f--; )
      a = n[f], a.scaleX = a.scaleY = 0, a.renderTransform(1, a);
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var Cr = "x,translateX,left,marginLeft,xPercent".split(","), vr = "y,translateY,top,marginTop,yPercent".split(","), br = Math.PI / 180, U, jt, ue, He, De, xt, yr = function() {
  return U || typeof window < "u" && (U = window.gsap) && U.registerPlugin && U;
}, Ce = function(e, t, r, n) {
  for (var i = t.length, s = n === 2 ? 0 : n, c = 0; c < i; c++)
    e[s] = parseFloat(t[c][r]), n === 2 && (e[s + 1] = 0), s += 2;
  return e;
}, de = function(e, t, r) {
  ...
  for (n = 2; n < e.length; n += 2)
    t = e[n] += t, r = e[n + 1] += r;
}, mt = function(e, t, r, n, i, s, c, f, a) {
  if (c.type === "cubic")
    t = [t];
  else {
    c.fromCurrent !== !1 && t.unshift(de(r, n, f), i ? de(r, i, a) : 0), c.relative && St(t);
    var d = i ? Ie : fr;
    t = [d(t, c.curviness)];
  }
  return t = s(Mt(t, r, c)), $e(e, r, n, t, "x", f), i && $e(e, r, i, t, "y", a), le(t, c.resolution || (c.curviness === 0 ? 20 : 12));
}, _r = function(e) {
  return e;
}, wr = /[-+\.]*\d+\.?(?:e-|e\+)?\d*/g, Ct = function(e, t, r) {
  var n = he(e), i = 0, s = 0, c;
  return (e.tagName + "").toLowerCase() === "svg" ? (c = e.viewBox.baseVal, c.width || (c = {
    width: +e.getAttribute("width"),
    height: +e.getAttribute("height")
  })) : c = t && e.getBBox && e.getBBox(), t && t !== "auto" && (i = t.push ? t[0] * (c ? c.width : e.offsetWidth || 0) : t.x, s = t.push ? t[1] * (c ? c.height : e.offsetHeight || 0) : t.y), r.apply(i || s ? n.apply({
    x: i,
    y: s
  }) : {
    x: n.e,
  ...
  var i = he(e.parentNode, !0, !0), s = i.clone().multiply(he(t)), c = Ct(e, r, i), f = Ct(t, n, i), a = f.x, d = f.y, u;
  return s.e = s.f = 0, n === "auto" && t.getTotalLength && t.tagName.toLowerCase() === "path" && (u = t.getAttribute("d").match(wr) || [], u = s.apply({
    x: +u[0],
    y: +u[1]
  }), a += u.x, d += u.y), u && (u = s.apply(t.getBBox()), a -= u.x, d -= u.y), s.e = a - c.x, s.f = d - c.y, s;
}, Mt = function(e, t, r) {
  var n = r.align, i = r.matrix, s = r.offsetX, c = r.offsetY, f = r.alignOrigin, a = e[0][0], d = e[0][1], u = de(t, "x"), h = de(t, "y"), g, x, p;
  return !e || !e.length ? Re("M0,0L0,0") : (n && (n === "self" || (g = He(n)[0] || t) === t ? ve(e, 1, 0, 0, 1, u - a, h - d) : (f && f[2] !== !1 ? U.set(t, {
    transformOrigin: f[0] * 100 + "% " + f[1] * 100 + "%"
  }) : f = [de(t, "xPercent") / -100, de(t, "yPercent") / -100], x = qe(t, g, f, "auto"), p = x.apply({
    x: a,
    y: d
  }), ve(e, x.a, x.b, x.c, x.d, u + x.e - (p.x - x.e), h + x.f - (p.y - x.f)))), i ? ve(e, i.a, i.b, i.c, i.d, i.e, i.f) : (s || c) && ve(e, 1, 0, 0, 1, s || 0, c || 0), e);
}, $e = function(e, t, r, n, i, s) {
  var c = t._gsap, f = c.harness, a = f && f.aliases && f.aliases[r], d = a && a.indexOf(",") < 0 ? a : r, u = e._pt = new jt(e._pt, t, d, 0, 0, _r, 0, c.set(t, d, e));
  u.u = ue(c.get(t, d, s)) || 0, u.path = n, u.pp = i, e._props.push(d);
}, Er = function(e, t) {
  return function(r) {
  ...
  init: function(e, t, r) {
    ...
    var n = [], i = t, s = i.path, c = i.autoRotate, f = i.unitX, a = i.unitY, d = i.x, u = i.y, h = s[0], g = Er(t.start, "end" in t ? t.end : 1), x, p;
    if (this.rawPaths = n, this.target = e, this.tween = r, this.styles = De && De(e, "transform"), (this.rotate = c || c === 0) && (this.rOffset = parseFloat(c) || 0, this.radians = !!t.useRadians, this.rProp = t.rotation || "rotation", this.rSet = e._gsap.set(e, this.rProp, this), this.ru = ue(e._gsap.get(e, this.rProp)) || 0), Array.isArray(s) && !("closed" in s) && typeof h != "number") {
      for (p in h)
        !d && ~Cr.indexOf(p) ? d = p : !u && ~vr.indexOf(p) && (u = p);
      d && u ? n.push(mt(this, Ce(Ce([], s, d, 0), s, u, 1), e, d, u, g, t, f || ue(s[0][d]), a || ue(s[0][u]))) : d = u = 0;
      for (p in h)
...
const Rr = ({ children: o }) => /* @__PURE__ */ v.jsxs("div", { className: "relative flex flex-col min-h-screen bg-gray-100 dark:bg-darkGrayBg theme-text font-[RobotoCondensed] ", children: [
  ...
  const r = it(null), n = it(
    ...
    const a = ee.utils.selector(r.current), d = a(".stroke-fng");
    s(d), i(a), n.current.play();
  }, f = () => {
    if (r.current) {
      const a = ee.utils.selector(r.current), d = a(".stroke-fng");
      n.current.reverse(), ee.killTweensOf(d), s(d, !0), ee.killTweensOf(a(".scanner")), ee.set(a(".scanner"), { y: 0, opacity: 0 });
    }
  };
  return /* @__PURE__ */ v.jsx(
    "button",
    {
      ...
      children: /* @__PURE__ */ v.jsx(Nr, { ref: r })
    }
  );
};
export {
