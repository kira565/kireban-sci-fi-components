...
import Le, { useMemo as _e, createElement as Oe, useRef as xe } from "react";
import N from "gsap";
var W = { exports: {} }, O = {};
/**
 * @license React
...
function Se() {
  return he || (he = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function d() {
      if (L === 0) {
        oe = console.log, ne = console.info, ae = console.warn, le = console.error, se = console.group, ce = console.groupCollapsed, ie = console.groupEnd;
        var e = {
          configurable: !0,
          enumerable: !0,
          value: i,
...
` + z + e + de;
    ...
    function v(e, t) {
      ...
      try {
        ...
        var n = g.DetermineComponentFrameRoot(), E = n[0], R = n[1];
        if (E && R) {
          var h = E.split(`
`), y = R.split(`
`);
          for (n = m = 0; m < h.length && !h[m].includes(
          ...
          if (m === h.length || n === y.length)
            for (m = h.length - 1, n = y.length - 1; 1 <= m && 0 <= n && h[m] !== y[n]; )
              n--;
          for (; 1 <= m && 0 <= n; m--, n--)
            if (h[m] !== y[n]) {
              if (m !== 1 || n !== 1)
...
` + h[m].replace(
                    ...
                    return e.displayName && _.includes("<anonymous>") && (_ = _.replace("<anonymous>", e.displayName)), typeof e == "function" && F.set(e, _), _;
                  }
                while (1 <= m && 0 <= n);
              break;
            }
      ...
      return h = (h = e ? e.displayName || e.name : "") ? x(h) : "", typeof e == "function" && F.set(e, h), h;
    }
    function f(e) {
      if (e == null) return "";
      if (typeof e == "function") {
    ...
    function I(e, t, r, s, g, m) {
      if (typeof e == "string" || typeof e == "function" || e === P || e === Q || e === K || e === Y || e === G || e === je || typeof e == "object" && e !== null && (e.$$typeof === B || e.$$typeof === U || e.$$typeof === ee || e.$$typeof === q || e.$$typeof === Z || e.$$typeof === Te || e.getModuleId !== void 0)) {
        var n = t.children;
        if (n !== void 0)
          if (s)
            if (H(n)) {
      ...
      if (re.call(t, "key")) {
        ...
        s = 0 < E.length ? "{key: someKey, " + E.join(": ..., ") + ": ...}" : "{key: someKey}", me[n + s] || (E = 0 < E.length ? "{" + E.join(": ..., ") + ": ...}" : "{}", console.error(
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
      ...
      if (n = null, r !== void 0 && (c(r), n = "" + r), T(t) && (c(t.key), n = "" + t.key), "key" in t) {
        r = {};
        for (var R in t)
          R !== "key" && (r[R] = t[R]);
      } else r = t;
    ...
    function X(e, t) {
      if (typeof e == "object" && e && e.$$typeof !== Re) {
        ...
        else if (e === null || typeof e != "object" ? r = null : (r = te && e[te] || e["@@iterator"], r = typeof r == "function" ? r : null), typeof r == "function" && r !== e.entries && (r = r.call(e), r !== e))
          for (; !(e = r.next()).done; )
            $(e.value) && D(e.value, t);
      }
    }
    ...
    function D(e, t) {
      if (e._store && !e._store.validated && e.key == null && (e._store.validated = 1, t = Ne(t), !Ce[t])) {
        Ce[t] = !0;
        var r = "";
        e && e._owner != null && e._owner !== p() && (r = null, typeof e._owner.tag == "number" ? r = a(e._owner.type) : typeof e._owner.name == "string" && (r = e._owner.name), r = " It was passed a child from " + r + ".");
...
Check the top-level render call using <` + e + ">."), t;
    ...
    var ke = Le, V = Symbol.for("react.transitional.element"), we = Symbol.for("react.portal"), P = Symbol.for("react.fragment"), K = Symbol.for("react.strict_mode"), Q = Symbol.for("react.profiler"), q = Symbol.for("react.consumer"), ee = Symbol.for("react.context"), Z = Symbol.for("react.forward_ref"), Y = Symbol.for("react.suspense"), G = Symbol.for("react.suspense_list"), U = Symbol.for("react.memo"), B = Symbol.for("react.lazy"), je = Symbol.for("react.offscreen"), te = Symbol.iterator, ye = Symbol.for("react.client.reference"), w = ke.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, re = Object.prototype.hasOwnProperty, j = Object.assign, Te = Symbol.for("react.client.reference"), H = Array.isArray, L = 0, oe, ne, ae, le, se, ce, ie;
    i.__reactDisabledLog = !0;
    var z, de, J = !1, F = new (typeof WeakMap == "function" ? WeakMap : Map)(), Re = Symbol.for("react.client.reference"), ue, fe = {}, me = {}, Ce = {};
    M.Fragment = P, M.jsx = function(e, t, r, s, g) {
...
var ve;
function Ae() {
  return ve || (ve = 1, process.env.NODE_ENV === "production" ? W.exports = Me() : W.exports = Se()), W.exports;
}
var o = Ae();
const Ge = ({
  children: a,
  mode: u = "warning",
  pulseAnimation: c = !0
}) => /* @__PURE__ */ o.jsx("div", { className: `piece ${c && "animate-pulse"}`, children: /* @__PURE__ */ o.jsx(
  "div",
  {
  ...
  return /* @__PURE__ */ o.jsxs("div", { className: "h-[135px] flex flex-col", style: { width: `${a * 10}px` }, children: [
    ...
    /* @__PURE__ */ o.jsx("div", { className: "h-[105px] flex flex-row overflow-hidden gap-[3px]", children: c() }),
    /* @__PURE__ */ o.jsx("div", { className: "h-[15px]" })
  ] });
}, Be = ({ unitNumber: a, subjectName: u }) => /* @__PURE__ */ o.jsxs("div", { className: "grid grid-rows-3 p-2 h-[135px] w-auto text-evaTextWarning text-shadow-warning text-center bg-red-600 bg-opacity-20 border-2 border-evaTextDanger glowedBorder", children: [
  ...
  function i() {
    return Array(a).fill(null).map((d, C) => /* @__PURE__ */ o.jsx("div", { className: "hex-row rotate-method", children: Array(u).fill(null).map((x, v) => /* @__PURE__ */ o.jsx("div", { className: `hex ${c ? "animation-active" : ""}` }, v)) }, C));
  }
  ...
  }, c = (C, x) => (C % x).toString(), i = `U-${c(a * 3, 9)}`, d = `${u(a, 20)}${c(a * 7, 99)}`;
  return `${i}${d}`;
}, [a]), Ve = ({ title: a, sciFiCode: u, isActive: c }) => {
  const i = $e(u);
      ...
      children: [
        /* @__PURE__ */ o.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ o.jsx("div", { className: "rotate-90 text-[0.45rem] text-nowrap font-bold m-1", children: i })
          }
        ),
        /* @__PURE__ */ o.jsxs(
          "div",
...
}, He = ({ options: a, width: u = "w-full" }) => /* @__PURE__ */ o.jsx("div", { className: `flex flex-col gap-2 ${u}`, children: a.map((c, i) => /* @__PURE__ */ Oe(Ve, { ...c, key: i, sciFiCode: i })) }), pe = () => /* @__PURE__ */ o.jsxs("div", { className: "w-[150px] h-[50px] flex flex-row align-top gap-[2px]", children: [
  ...
  /* @__PURE__ */ o.jsx("div", { className: "h-[4px] w-[7px] artifact-border self-end rounded-none glowedGray bg-white ml-5" })
] }), ze = ({ children: a }) => /* @__PURE__ */ o.jsxs("div", { className: "relative flex flex-col min-h-screen bg-gray-100 dark:bg-darkGrayBg theme-text font-[RobotoCondensed] ", children: [
  /* @__PURE__ */ o.jsxs("div", { className: "sticky top-0 bg-gray-100 dark:bg-darkGrayBg w-full shadow-md z-10 flex gap-2 items-center border-b-evaTextDanger glowed-border-b", children: [
    /* @__PURE__ */ o.jsx("div", { className: "ml-2 mt-2 hidden md:block z-10", children: /* @__PURE__ */ o.jsx(We, { tilesPerRowCount: 2, rowsCount: 2 }) }),
    /* @__PURE__ */ o.jsx(
      "div",
      {
  ...
  /* @__PURE__ */ o.jsx("div", { className: "fixed bottom-3 left-3", children: /* @__PURE__ */ o.jsx(pe, {}) }),
  /* @__PURE__ */ o.jsx("div", { className: "fixed bottom-3 right-3 [transform:rotateY(180deg)]", children: /* @__PURE__ */ o.jsx(pe, {}) }),
  ...
  mainBlockChildren: C,
  animated: x
}) => /* @__PURE__ */ o.jsxs("div", { className: "card-container relative", style: { width: u, height: c }, children: [
  /* @__PURE__ */ o.jsxs(
    "div",
    {
  ...
  const c = xe(null), i = xe(
    ...
    const f = N.utils.selector(c.current), p = f(".stroke-fng");
    C(p), d(f), i.current.play();
  }, v = () => {
    if (c.current) {
      const f = N.utils.selector(c.current), p = f(".stroke-fng");
      i.current.reverse(), N.killTweensOf(p), C(p, !0), N.killTweensOf(f(".scanner")), N.set(f(".scanner"), { y: 0, opacity: 0 });
    }
  };
  return /* @__PURE__ */ o.jsx(
    "button",
    {
      ...
      children: /* @__PURE__ */ o.jsx(Pe, { ref: c })
    }
  );
};
export {
