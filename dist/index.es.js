  ...
  <%s key={someKey} {...props} />`,
    ...
    function x(g, E) {
      if (g._store && !g._store.validated && g.key == null && (g._store.validated = 1, E = y(E), !Ai[E])) {
        Ai[E] = !0;
        var P = "";
        g && g._owner != null && g._owner !== f() && (P = null, typeof g._owner.tag == "number" ? P = a(g._owner.type) : typeof g._owner.name == "string" && (P = g._owner.name), P = " It was passed a child from " + P + ".");
...
var bt = {
  ...
  var n = t.ratio, s = e < 0 || !e && (!t._start && Xs(t) && !(!t._initted && Gr(t)) || (t._ts < 0 || t._dp._ts < 0) && !Gr(t)) ? 0 : 1, o = t._rDelay, l = 0, f, u, h;
  if (o && t._repeat && (l = Je(0, t._tDur, e), u = Se(l, o), t._yoyo && u & 1 && (s = 1 - s), u !== Se(t._tTime, o) && (n = 1 - s, t.vars.repeatRefresh && t._initted && t.invalidate())), s !== n || at || i || t._zTime === W || !e && t._zTime) {
    if (!t._initted && Pn(t, e, i, r, l))
      return;
    for (h = t._zTime, t._zTime = e || (r ? W : 0), r || (r = e && !h), t.ratio = s, t._from && (s = 1 - s), t._time = 0, t._tTime = l, f = t._pt; f; )
      f.r(s, f.d), f = f._next;
    e < 0 && Xr(t, e, r, !0), t._onUpdate && !r && vt(t, "onUpdate"), l && t._repeat && !r && t.parent && vt(t, "onRepeat"), (e >= t._tDur || e < 0) && t.ratio === s && (s && Qt(t, 1), !r && !at && (vt(t, s ? "onComplete" : "onReverseComplete", !0), t._prom && t._prom()));
  ...
  var i = t.labels, n = t._recent || qs, s = t.duration() >= St ? n.endTime(!1) : t._dur, o, l, f;
  return rt(e) && (isNaN(e) || e in i) ? (l = e.charAt(0), f = e.substr(-1) === "%", o = e.indexOf("="), l === "<" || l === ">" ? (o >= 0 && (e = e.replace(/=/, "")), (l === "<" ? n._start : n.endTime(n._repeat >= 0)) + (parseFloat(e.substr(1)) || 0) * (f ? (o < 0 ? n : r).totalDuration() / 100 : 1)) : o < 0 ? (e in i || (i[e] = s), i[e]) : (l = parseFloat(e.charAt(o - 1) + e.substr(o + 1)), f && r && (l = l / 100 * (lt(r) ? r[0] : r).totalDuration()), o > 1 ? a(t, e.substr(0, o - 1), r) + l : s + l)) : e == null ? s : +e;
}, Ve = function(t, e, r) {
  var i = Wt(e[1]), n = (i ? 2 : 1) + (t < 2 ? 0 : 1), s = e[n], o, l;
  ...
  var e = zt(t) ? t : {
    each: t
  }, r = le(e.ease), i = e.from || 0, n = parseFloat(e.base) || 0, s = {}, o = i > 0 && i < 1, l = isNaN(i) || o, f = e.axis, u = i, h = i;
  return rt(i) ? u = h = {
    center: 0.5,
    edges: 0.5,
    end: 1
  }[i] || 0 : !o && l && (u = i[0], h = i[1]), function(_, d, p) {
    ...
    if (!m) {
      ...
      for (m = s[c] = [], x = l ? Math.min(C, c) * u - 0.5 : i % C, y = C === St ? 0 : l ? c * h / C - 0.5 : i / C | 0, k = 0, S = St, T = 0; T < c; T++)
        v = T % C - x, w = y - (T / C | 0), m[T] = b = f ? Math.abs(f === "y" ? w : v) : cn(v * v + w * w), b > k && (k = b), b < S && (S = b);
      i === "random" && Mn(m), m.max = k - S, m.min = S, m.v = c = (parseFloat(e.amount) || parseFloat(e.each) * (C > c ? c - 1 : f ? f === "y" ? c / C : C : Math.max(C, c / C)) || 0) * (i === "edges" ? -1 : 1), m.b = c < 0 ? n - c : n, m.u = ot(e.amount || e.each) || 0, r = r && c < 0 ? In(r) : r;
    }
  ...
  return !r && zt(t) && (i = r = t.radius || St, t.values ? (t = Et(t.values), (n = !Wt(t[0])) && (i *= i)) : t = Hr(t.increment)), te(e, r ? H(t) ? function(s) {
    ...
    for (var o = parseFloat(n ? s.x : s), l = parseFloat(n ? s.y : 0), f = St, u = 0, h = t.length, _, d; h--; )
      n ? (_ = t[h].x - o, d = t[h].y - l, _ = _ * _ + d * d) : _ = Math.abs(t[h] - o), _ < f && (f = _, u = h);
    return u = !i || f <= i ? t[u] : s, n || u === s || Wt(s) ? u : u + ot(s);
  } : Hr(t));
}, An = function(t, e, r, i) {
  ...
  if (!n) {
    ...
    if (r === !0 && (i = 1) && (r = null), s)
      ...
      for (u = [], h = t.length, _ = h - 2, f = 1; f < h; f++)
        u.push(a(t[f - 1], t[f]));
      h--, n = function(p) {
        p *= h;
        var c = Math.min(_, ~~p);
  ...
  var i = t.labels, n = St, s, o, l;
  for (s in i)
    o = i[s] - e, o < 0 == !!r && o && n > (o = Math.abs(o)) && (l = s, n = o);
  return l;
}, vt = function(t, e, r) {
  var i = t.vars, n = i[e], s = U, o = t._ctx, l, f, u;
  if (n)
    return l = i[e + "Params"], f = i.callbackScope || t, r && Ht.length && _r(), o && (U = o), u = l ? n.apply(f, l) : n.call(f), U = s, u;
}, De = function(t) {
  ...
  var i = t ? Wt(t) ? [t >> 16, t >> 8 & $, t & $] : 0 : je.black, n, s, o, l, f, u, h, _, d, p;
  if (!i) {
    if (t.substr(-1) === "," && (t = t.substr(0, t.length - 1)), je[t])
      ...
      if (i = p = t.match(Yr), !e)
        l = +i[0] % 360 / 360, f = +i[1] / 100, u = +i[2] / 100, s = u <= 0.5 ? u * (f + 1) : u + f - u * f, n = u * 2 - s, i.length > 3 && (i[3] *= 1), i[0] = Rr(l + 1 / 3, n, s), i[1] = Rr(l, n, s), i[2] = Rr(l - 1 / 3, n, s);
      else if (~t.indexOf("="))
  ...
  return e && !p && (n = i[0] / $, s = i[1] / $, o = i[2] / $, h = Math.max(n, s, o), _ = Math.min(n, s, o), u = (h + _) / 2, h === _ ? l = f = 0 : (d = h - _, f = u > 0.5 ? d / (2 - h - _) : d / (h + _), l = h === n ? (s - o) / d + (s < o ? 6 : 0) : h === s ? (o - n) / d + 2 : (n - s) / d + 4, l *= 60), i[0] = ~~(l + 0.5), i[1] = ~~(f * 100 + 0.5), i[2] = ~~(u * 100 + 0.5)), r && i.length < 4 && (i[3] = 1), i;
}, Bn = function(t) {
  var e = [], r = [], i = -1;
  ...
  var i = "", n = (t + i).match(Jt), s = e ? "hsla(" : "rgba(", o = 0, l, f, u, h;
  if (!n)
    return t;
  if (n = n.map(function(_) {
    return (_ = Fn(_, e, 1)) && s + (e ? _[0] + "," + _[1] + "%," + _[2] + "%," + _[3] : _.join(",")) + ")";
  }), r && (u = Bn(t), l = r.c, l.join(i) !== u.c.join(i)))
    for (f = t.replace(Jt, "1").split(xe), h = f.length - 1; o < h; o++)
      i += f[o] + (~l.indexOf(o) ? n.shift() || s + "0,0,0,0)" : (u.length ? u : n.length ? n : r).shift());
  if (!f)
    for (f = t.split(Jt), h = f.length - 1; o < h; o++)
      i += f[o] + n[o];
  return i + f[h];
}, Jt = function() {
  ...
  var a = Date.now, t = 500, e = 33, r = a(), i = r, n = 1e3 / 240, s = n, o = [], l, f, u, h, _, d, p = function c(m) {
    var x = a() - i, y = m === !0, v, w, b, T;
    if ((x > t || x < 0) && (r += x - e), i += x, b = i - r, v = b - s, (v > 0 || y) && (T = ++h.frame, _ = b - h.time * 1e3, h.time = b = b / 1e3, s += v + (v >= n ? 4 : n - v), w = 1), y || (l = f(c)), w)
  ...
  return h = {
    ...
    wake: function() {
      mn && (!Wr && hi() && (At = Wr = window, ci = At.document || {}, Ct.gsap = mt, (At.gsapVersions || (At.gsapVersions = [])).push(mt.version), xn(cr || At.GreenSockGlobals || !At.gsap && At || {}), jn.forEach(zn)), u = typeof requestAnimationFrame < "u" && requestAnimationFrame, l && h.sleep(), f = u || function(m) {
        return setTimeout(m, s - h.time * 1e3 + 1 | 0);
      }, Xe = 1, p(2));
    },
    sleep: function() {
      (u ? cancelAnimationFrame : clearTimeout)(l), Xe = 0, f = We;
    },
  ...
  for (var e = {}, r = t.substr(1, t.length - 3).split(":"), i = r[0], n = 1, s = r.length, o, l, f; n < s; n++)
    l = r[n], o = n !== s - 1 ? l.lastIndexOf(",") : l.length, f = l.substr(0, o), e[i] = isNaN(f) ? f.replace(oo, "").trim() : +f, i = l.substr(o + 1).trim();
  return e;
}, lo = function(t) {
  ...
  return dt(t, function(o) {
    ...
    for (var l in n)
      D[s + (l === "easeIn" ? ".in" : l === "easeOut" ? ".out" : ".inOut")] = D[o + "." + l] = n[l];
  }), n;
}, Yn = function(t) {
  return function(e) {
  ...
  }, l = t === "out" ? o : t === "in" ? function(f) {
    return 1 - o(1 - f);
  } : Yn(o);
  return n = $r / n, l.config = function(f, u) {
    return a(t, f, u);
  }, l;
}, Lr = function a(t, e) {
  e === void 0 && (e = 1.70158);
  ...
  return t.delay = function(r) {
    ...
    return new Promise(function(n) {
      var s = H(r) ? r : Tn, o = function() {
        var f = i.then;
        i.then = null, H(s) && (s = s(i)) && (s.then || s === i) && (i.then = f), n(s), i.then = f;
      };
...
var ct = /* @__PURE__ */ function(a) {
  ...
  return e.to = function(i, n, s) {
  ...
  }, e.staggerTo = function(i, n, s, o, l, f, u) {
    return s.duration = n, s.stagger = s.stagger || o, s.onComplete = f, s.onCompleteParams = u, s.parent = this, new K(i, s, Tt(this, l)), this;
  }, e.staggerFrom = function(i, n, s, o, l, f, u) {
    return s.runBackwards = 1, Be(s).immediateRender = _t(s.immediateRender), this.staggerTo(i, n, s, o, l, f, u);
  }, e.staggerFromTo = function(i, n, s, o, l, f, u, h) {
    return o.startAt = s, Be(o).immediateRender = _t(o.immediateRender), this.staggerTo(i, n, o, l, f, u, h);
  }, e.render = function(i, n, s) {
    var o = this._time, l = this._dirty ? this.totalDuration() : this._tDur, f = this._dur, u = i <= 0 ? 0 : et(i), h = this._zTime < 0 != i < 0 && (this._initted || !f), _, d, p, c, m, x, y, v, w, b, T, k;
    if (this !== Z && u > l && i >= 0 && (u = l), u !== this._tTime || s || h) {
      if (o !== this._time && f && (u += this._time - o, i += this._time - o), _ = u, w = this._start, v = this._ts, x = !v, h && (f || (o = this._zTime), (i || !n) && (this._zTime = i)), this._repeat) {
        if (T = this._yoyo, m = f + this._rDelay, this._repeat < -1 && i < 0)
          return this.totalTime(m * 100 + i, n, s);
        if (_ = et(u % m), u === l ? (c = this._repeat, _ = f) : (c = ~~(u / m), c && c === u / m && (_ = f, c--), _ > f && (_ = f)), b = Se(this._tTime, m), !o && this._tTime && b !== c && this._tTime - b * m - this._dur <= 0 && (b = c), T && c & 1 && (_ = f - _, k = 1), c !== b && !this._lock) {
          var S = T && b & 1, C = S === (T && c & 1);
          if (c < b && (S = !S), o = S ? 0 : u % f ? f : u, this._lock = 1, this.render(o || (k ? 0 : et(c * m)), n, !f)._lock = 0, this._tTime = u, !n && this.parent && vt(this, "onRepeat"), this.vars.repeatRefresh && !k && (this.invalidate()._lock = 1), o && o !== this._time || x !== !this._ts || this.vars.onRepeat && !this.parent && !this._act)
            return this;
          if (f = this._dur, l = this._tDur, C && (this._lock = 2, o = S ? f : -1e-4, this.render(o, !0), this.vars.repeatRefresh && !k && this.invalidate()), this._lock = 0, !this._ts && !x)
            return this;
          $n(this, k);
        }
      }
      ...
      this._onUpdate && !n && vt(this, "onUpdate", !0), (u === l && this._tTime >= this.totalDuration() || !u && o) && (w === this._start || Math.abs(v) !== Math.abs(this._ts)) && (this._lock || ((i || !f) && (u === l && this._ts > 0 || !u && this._ts < 0) && Qt(this, 1), !n && !(i < 0 && !o) && (u || o || !l) && (vt(this, u === l && i >= 0 ? "onComplete" : "onReverseComplete", !0), this._prom && !(u < l && this.timeScale() > 0) && this._prom())));
    }
    return this;
  }, e.add = function(i, n) {
    var s = this;
    ...
    for (var l = [], f = this._first; f; )
      f._start >= o && (f instanceof K ? n && l.push(f) : (s && l.push(f), i && l.push.apply(l, f.getChildren(!0, n, s)))), f = f._next;
    return l;
    ...
    for (var s = [], o = Et(i), l = this._first, f = Wt(n), u; l; )
      l instanceof K ? Is(l._targets, o) && (f ? (!Gt || l._initted && l._ts) && l.globalTime(0) <= n && l.globalTime(l.totalDuration()) > n : !n || l.isActive()) && s.push(l) : (u = l.getTweensOf(o, n)).length && s.push.apply(s, u), l = l._next;
    return s;
  }, e.tweenTo = function(i, n) {
    n = n || {};
    var s = this, o = Tt(s, i), l = n, f = l.startAt, u = l.onStart, h = l.onStartParams, _ = l.immediateRender, d, p = K.to(s, Ot({
      ease: n.ease || "none",
      lazy: !1,
      immediateRender: !1,
      time: o,
      overwrite: "auto",
      duration: n.duration || Math.abs((o - (f && "time" in f ? f.time : s._time)) / s.timeScale()) || W,
      onStart: function() {
        if (s.pause(), !d) {
    ...
    s === void 0 && (s = 0);
    for (var o = this._first, l = this.labels, f; o; )
    ...
    var n = 0, s = this, o = s._last, l = St, f, u, h;
    if (arguments.length)
      return s.timeScale((s._repeat < 0 ? s.duration() : s.totalDuration()) / (s.reversed() ? -i : i));
    if (s._dirty) {
      for (h = s.parent; o; )
        f = o._prev, o._dirty && o.totalDuration(), u = o._start, u > l && s._sort && o._ts && !s._lock ? (s._lock = 1, Lt(s, o, u - o._delay, 1)._lock = 0) : l = u, u < 0 && o._ts && (n -= u, (!h && !s._dp || h && h.smoothChildTiming) && (s._start += u / s._ts, s._time -= u, s._tTime -= u), s.shiftChildren(-u, !1, -1 / 0), l = 0), o._end > n && o._ts && (n = o._end), o = f;
...
var uo = function(t, e, r, i, n, s, o) {
  var l = new pt(this._pt, t, e, 0, 1, Hn, null, n), f = 0, u = 0, h, _, d, p, c, m, x, y;
  for (l.b = r, l.e = i, r += "", i += "", (x = ~i.indexOf("random(")) && (i = Ue(i)), s && (y = [r, i], s(y, t, e), r = y[0], i = y[1]), _ = r.match(Mr) || []; h = Mr.exec(i); )
    p = h[0], c = i.substring(f, h.index), d ? d = (d + 1) % 5 : c.substr(-5) === "rgba(" && (d = 1), p !== _[u++] && (m = parseFloat(_[u - 1]) || 0, l._pt = {
      _next: l._pt,
      p: c || u === 1 ? c : ",",
  ...
  return l.c = f < i.length ? i.substring(f, i.length) : "", l.fp = o, (pn.test(i) || x) && (l.e = 0), this._pt = l, l;
}, mi = function(t, e, r, i, n, s, o, l, f, u) {
  H(i) && (i = i(n || 0, t, s));
  var h = t[e], _ = r !== "get" ? r : H(h) ? f ? t[e.indexOf("set") || !H(t["get" + e.substr(3)]) ? e : "get" + e.substr(3)](f) : t[e]() : h, d = H(h) ? f ? go : Zn : yi, p;
  if (rt(i) && (~i.indexOf("random(") && (i = Ue(i)), i.charAt(1) === "=" && (p = be(_, i) + (ot(_) || 0), (p || p === 0) && (i = p))), !u || _ !== i || Jr)
    return !isNaN(_ * i) && i !== "" ? (p = new pt(this._pt, t, e, +_ || 0, i - (_ || 0), typeof h == "boolean" ? xo : qn, 0, d), f && (p.fp = f), o && p.modifier(o, this, t), this._pt = p) : (!h && !(e in t) && _i(e, i), uo.call(this, t, e, _, i, d, l || bt.stringFilter, f));
  ...
  var o, l, f, u;
  if (xt[t] && (o = new xt[t]()).init(n, o.rawVars ? e[t] : ho(e[t], i, n, s, r), r, i, s) !== !1 && (r._pt = l = new pt(r._pt, n, t, 0, 1, o.render, o, 0, o.priority), r !== ye))
    for (f = r._ptLookup[r._targets.indexOf(n)], u = o._props.length; u--; )
      f[o._props[u]] = l;
  return o;
}, Gt, Jr, xi = function a(t, e, r) {
  var i = t.vars, n = i.ease, s = i.startAt, o = i.immediateRender, l = i.lazy, f = i.onUpdate, u = i.runBackwards, h = i.yoyoEase, _ = i.keyframes, d = i.autoRevert, p = t._dur, c = t._startAt, m = t._targets, x = t.parent, y = x && x.data === "nested" ? x.vars.targets : m, v = t._overwrite === "auto" && !fi, w = t.timeline, b, T, k, S, C, M, N, A, R, I, z, F, Y;
  if (w && (!_ || !n) && (n = "none"), t._ease = le(n, ke.ease), t._yEase = h ? In(le(h === !0 ? n : h, ke.ease)) : 0, h && t._yoyo && !t._repeat && (h = t._yEase, t._yEase = t._ease, t._ease = h), t._from = !w && !!i.runBackwards, !w || _ && !i.stagger) {
    ...
    for (t._pt = t._ptCache = 0, l = p && _t(l) || l && !p, T = 0; T < m.length; T++) {
      ...
      t._op && t._op[T] && t.kill(C, t._op[T]), v && t._pt && (Gt = t, Z.killTweensOf(C, I, t.globalTime(e)), Y = !t.parent, Gt = 0), t._pt && l && (Ur[N.id] = 1);
    }
    M && Jn(t), t._onInit && t._onInit(t);
  }
  t._onUpdate = f, t._initted = (!t._op || t._pt) && !Y, _ && e <= 0 && w.render(St, !0, !0);
}, co = function(t, e, r, i, n, s, o, l) {
  var f = (t._pt && t._ptCache || (t._ptCache = {}))[e], u, h, _, d;
  if (!f)
    for (f = t._ptCache[e] = [], _ = t._ptLookup, d = t._targets.length; d--; ) {
      if (u = _[d][e], u && u.d && u.d._pt)
        for (u = u.d._pt; u && u.p !== e && u.fp !== e; )
          u = u._next;
      if (!u)
        return Jr = 1, t.vars[e] = "+=0", xi(t, o), Jr = 0, l ? Ye(e + " not eligible for reset") : 1;
      f.push(u);
    }
  for (d = f.length; d--; )
    h = f[d], u = h._pt || h, u.s = (i || i === 0) && !n ? i : u.s + (i || 0) + s * u.c, u.c = r - u.s, h.e && (h.e = J(r) + ot(h.e)), h.b && (h.b = u.s + ot(h.b));
}, _o = function(t, e) {
  var r = t[0] ? oe(t[0]).harness : 0, i = r && r.aliases, n, s, o, l;
  if (!i)
    return e;
  n = ce({}, e);
  for (s in i)
  ...
  if (lt(e))
    o = r[t] || (r[t] = []), e.forEach(function(l, f) {
      return o.push({
        t: f / (e.length - 1) * 100,
        v: l,
        e: n
...
var K = /* @__PURE__ */ function(a) {
  ...
  function t(r, i, n, s) {
    ...
    var l = o.vars, f = l.duration, u = l.delay, h = l.immediateRender, _ = l.stagger, d = l.overwrite, p = l.keyframes, c = l.defaults, m = l.scrollTrigger, x = l.yoyoEase, y = i.parent || Z, v = (lt(r) || _n(r) ? Wt(r[0]) : "length" in i) ? [r] : Et(r), w, b, T, k, S, C, M, N;
    if (o._targets = v.length ? gi(v) : Ye("GSAP target " + r + " not found. https://gsap.com", !bt.nullTargetWarn) || [], o._ptLookup = [], o._overwrite = d, p || _ || nr(f) || nr(u)) {
      if (i = o.vars, w = o.timeline = new ct({
        data: "nested",
        defaults: c || {},
        targets: y && y.data === "nested" ? y.vars.targets : v
      }), w.kill(), w.parent = w._dp = Vt(o), w._start = 0, _ || nr(f) || nr(u)) {
        if (k = v.length, M = _ && Nn(_), zt(_))
          for (S in _)
            ~Xn.indexOf(S) && (N || (N = {}), N[S] = _[S]);
        for (b = 0; b < k; b++)
          T = dr(i, Gn), T.stagger = 0, x && (T.yoyoEase = x), N && ce(T, N), C = v[b], T.duration = +Ie(f, Vt(o), b, C, v), T.delay = (+Ie(u, Vt(o), b, C, v) || 0) - o._delay, !_ && k === 1 && T.delay && (o._delay = u = T.delay, o._start += u, T.delay = 0), w.to(C, T, M ? M(b, C, v) : 0), w._ease = D.none;
        w.duration() ? f = u = 0 : o.timeline = 0;
      } else if (p) {
        ...
        if (lt(p))
          ...
          for (S in T)
            for (R = T[S].sort(function(F, Y) {
              ...
              I = R[b], z = {
                ease: I.e,
                duration: (I.t - (b ? R[b - 1].t : 0)) / 100 * f
      ...
      o.timeline = 0;
    return d === !0 && !fi && (Gt = Vt(o), Z.killTweensOf(v), Gt = 0), Lt(y, Vt(o), n), i.reversed && o.reverse(), i.paused && o.paused(!0), (h || !f && !p && o._start === et(y._time) && _t(h) && Us(Vt(o)) && y.data !== "nested") && (o._tTime = -W, o.render(Math.max(0, -u) || 0)), m && En(Vt(o), m), o;
  }
  var e = t.prototype;
  return e.render = function(i, n, s) {
    var o = this._time, l = this._tDur, f = this._dur, u = i < 0, h = i > l - W && !u ? l : i < W ? 0 : i, _, d, p, c, m, x, y, v, w;
    if (!f)
      Gs(this, i, n, s);
      ...
      if (_ = h, v = this.timeline, this._repeat) {
        ...
        if (_ = et(h % c), h === l ? (p = this._repeat, _ = f) : (p = ~~(h / c), p && p === et(h / c) && (_ = f, p--), _ > f && (_ = f)), x = this._yoyo && p & 1, x && (w = this._yEase, _ = f - _), m = Se(this._tTime, c), _ === o && !s && this._initted && p === m)
      ...
      if (this._tTime = h, this._time = _, !this._act && this._ts && (this._act = 1, this._lazy = 0), this.ratio = y = (w || this._ease)(_ / f), this._from && (this.ratio = y = 1 - y), _ && !o && !n && !p && (vt(this, "onStart"), this._tTime !== h))
        return this;
      for (d = this._pt; d; )
        d.r(y, d.d), d = d._next;
      v && v.render(i < 0 ? i : v._dur * v._ease(_ / this._dur), n, s) || this._startAt && (this._zTime = i), this._onUpdate && !n && (u && Xr(this, i, n, s), vt(this, "onUpdate")), this._repeat && p !== m && this.vars.onRepeat && !n && this.parent && vt(this, "onRepeat"), (h === this._tDur || !h) && this._tTime === h && (u && !this._onUpdate && Xr(this, i, !0, !0), (i || !f) && (h === this._tDur && this._ts > 0 || !h && this._ts < 0) && Qt(this, 1), !n && !(u && !o) && (h || o || x) && (vt(this, h === l ? "onComplete" : "onReverseComplete", !0), this._prom && !(h < l && this.timeScale() > 0) && this._prom()));
    }
    return this;
  }, e.targets = function() {
    ...
    return this._initted || xi(this, f), u = this._ease(f / this._dur), co(this, i, n, s, o, u, f, l) ? this.resetTo(i, n, s, o, 1) : (kr(this, 0), this.parent || kn(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0));
  }, e.kill = function(i, n) {
    ...
    var o = this._targets, l = i ? Et(i) : o, f = this._ptLookup, u = this._pt, h, _, d, p, c, m, x;
    if ((!n || n === "all") && Ys(o, l))
    ...
    for (h = this._op = this._op || [], n !== "all" && (rt(n) && (c = {}, dt(n, function(y) {
      ...
      if (~l.indexOf(o[x])) {
        _ = f[x], n === "all" ? (h[x] = n, p = _, d = {}) : (d = h[x] = h[x] || {}, p = n);
        for (c in p)
...
var yi = function(t, e, r) {
  ...
  function a(e, r, i, n, s, o, l, f, u) {
    this.t = r, this.s = n, this.c = s, this.p = i, this.r = o || qn, this.d = l || this, this.set = f || yi, this.pr = u || 0, this._next = e, e && (e._prev = this);
  }
  var t = a.prototype;
...
var fe = [], fr = {}, Co = [], Ui = 0, wo = 0, Dr = function(t) {
  ...
  t - Ui > 2 && (Dr("matchMediaInit"), fe.forEach(function(r) {
    var i = r.queries, n = r.conditions, s, o, l, f;
    for (o in i)
      s = At.matchMedia(i[o]).matches, s && (l = 1), s !== n[o] && (n[o] = s, f = 1);
    f && (r.revert(), l && e.push(r));
  ...
  return t.add = function(r, i, n) {
    ...
    var s = this, o = function() {
      var f = U, u = s.selector, h;
      return f && f !== s && f.data.push(s), n && (s.selector = qr(n)), U = s, h = i.apply(s, arguments), H(h) && s._r.push(h), U = f, s.selector = u, s.isReverted = !1, h;
    };
    return s.last = o, r === H ? o(s, function(l) {
      return s.add(null, l);
    }) : r ? s[r] = o : o;
  }, t.ignore = function(r) {
    var i = U;
    ...
    var n = this;
    if (r ? function() {
      for (var o = n.getTweens(), l = n.data.length, f; l--; )
        f = n.data[l], f.data === "isFlip" && (f.revert(), f.getChildren(!0, !0, !1).forEach(function(u) {
      ...
      for (o.map(function(u) {
        ...
        f = n.data[l], f instanceof ct ? f.data !== "nested" && (f.scrollTrigger && f.scrollTrigger.revert(), f.kill()) : !(f instanceof K) && f.revert && f.revert(r);
  ...
  return t.add = function(r, i, n) {
    ...
    var s = new Qn(0, n || this.scope), o = s.conditions = {}, l, f, u;
    U && !s.selector && (s.selector = U.selector), this.contexts.push(s), i = s.add("onMatch", i), s.queries = r;
    for (f in r)
      f === "all" ? u = 1 : (l = At.matchMedia(r[f]), l && (fe.indexOf(s) < 0 && fe.push(s), (o[f] = l.matches) && (u = 1), l.addListener ? l.addListener(Qr) : l.addEventListener("change", Qr)));
  ...
  getProperty: function(t, e, r, i) {
    ...
    return r === "native" && (r = ""), t && (e ? s((xt[e] && xt[e].get || n)(t, e, r, i)) : function(o, l, f) {
      return s((xt[o] && xt[o].get || n)(t, o, l, f));
    });
  },
  quickSetter: function(t, e, r) {
    ...
    t = t[0] || {};
    var s = xt[e], o = oe(t), l = o.harness && (o.harness.aliases || {})[e] || e, f = s ? function(u) {
      var h = new s();
      ye._pt = 0, h.init(t, r ? u + r : u, ye, 0, [t]), h.render(1, h), ye._pt && bi(1, ye);
    } : o.set(t, l);
    return s ? f : function(u) {
      return f(t, l, r ? u + r : u, o, 1);
    };
  },
  quickTo: function(t, e, r) {
    var i, n = mt.to(t, ce((i = {}, i[e] = "+=0.1", i.paused = !0, i), r || {})), s = function(l, f, u) {
      return n.resetTo(e, l, f, u);
    };
    return s.tween = n, s;
  },
  ...
  registerEffect: function(t) {
    ...
    (i || "").split(",").forEach(function(o) {
      ...
      return r(Et(o), Ot(l || {}, n), f);
    }, s && (ct.prototype[e] = function(o, l, f) {
      return this.add(Nr[e](o, zt(l) ? l : (f = l) && {}, this), f);
    });
  },
...
var ko = function(t, e) {
  ...
  init: function(t, e, r, i, n) {
    ...
    this.tween = r;
    for (s in e)
      l = t.getAttribute(s) || "", o = this.add(t, "setAttribute", (l || 0) + "", e[s], i, n, 0, 0, s), o.op = s, o.b = l, this._props.push(s);
  },
  render: function(t, e) {
    for (var r = e._pt; r; )
...
var Xi, Zt, Ce, Ci, se, Gi, wi, Eo = function() {
  ...
  var n = parseFloat(r) || 0, s = (r + "").trim().substr((n + "").length) || "px", o = se.style, l = Po.test(e), f = t.tagName.toLowerCase() === "svg", u = (f ? "client" : "offset") + (l ? "Width" : "Height"), h = 100, _ = i === "px", d = i === "%", p, c, m, x;
  if (i === s || !n || Ji[i] || Ji[s])
    return n;
  if (s !== "px" && !_ && (n = a(t, e, r, "px")), x = t.getCTM && ss(t), (d || s === "%") && (Ut[e] || ~e.indexOf("adius")))
    return p = x ? t.getBBox()[l ? "width" : "height"] : t[u], J(d ? n / p * h : n / 100 * p);
  if (o[l ? "width" : "height"] = h + (_ ? s : i), c = ~e.indexOf("adius") || i === "em" && t.appendChild && !f ? t : t.parentNode, x && (c = (t.ownerSVGElement || {}).parentNode), (!c || c === Zt || !c.appendChild) && (c = Zt.body), m = c._gsap, m && d && m.width && l && m.time === yt.time && !m.uncache)
  ...
  return l && d && (m = oe(c), m.time = yt.time, m.width = c[u]), J(_ ? p * n / h : p && n ? h / p * n : 0);
}, It = function(t, e, r, i) {
  var n;
  ...
  var o = new pt(this._pt, t.style, e, 0, 1, Hn), l = 0, f = 0, u, h, _, d, p, c, m, x, y, v, w, b;
  if (o.b = r, o.e = i, r += "", i += "", i === "auto" && (c = t.style[e], t.style[e] = i, i = jt(t, e) || i, c ? t.style[e] = c : _e(t, e)), u = [r, i], Vn(u), r = u[0], i = u[1], _ = r.match(xe) || [], b = i.match(xe) || [], b.length) {
    for (; h = xe.exec(i); )
      m = h[0], y = i.substring(l, h.index), p ? p = (p + 1) % 5 : (y.substr(-5) === "rgba(" || y.substr(-5) === "hsla(") && (p = 1), m !== (c = _[f++] || "") && (d = parseFloat(c) || 0, w = c.substr((d + "").length), m.charAt(1) === "=" && (m = be(d, m) + w), x = parseFloat(m), v = m.substr((x + "").length), l = xe.lastIndex - v.length, v || (v = v || bt.units[e] || w, l === i.length && (i += v, o.e += v)), w !== v && (d = Kt(t, e, c, v) || 0), o._pt = {
        _next: o._pt,
        p: y || f === 1 ? y : ",",
        //note: SVG spec allows omission of comma/space when a negative sign is wedged between two numbers, like 2.5-5.3 instead of 2.5,-5.3 but when tweening, the negative value may switch to positive, so we insert the comma just in case.
        s: d,
  ...
  if (e.tween && e.tween._time === e.tween._dur) {
    var r = e.t, i = r.style, n = e.u, s = r._gsap, o, l, f;
    if (n === "all" || n === !0)
      i.cssText = "", l = 1;
    else
      for (n = n.split(","), f = n.length; --f > -1; )
        o = n[f], Ut[o] && (l = 1, o = o === "transformOrigin" ? gt : q), _e(r, o);
    l && (_e(r, q), s && (s.svg && r.removeAttribute("transform"), qe(r, 1), s.uncache = 1, es(i)));
  }
}, mr = {
  ...
  */
  ...
  var r = t._gsap || oe(t), i = t.style, n = Ki(t), s, o, l, f;
  return r.svg && t.getAttribute("transform") ? (l = t.transform.baseVal.consolidate().matrix, n = [l.a, l.b, l.c, l.d, l.e, l.f], n.join(",") === "1,0,0,1,0,0" ? Ze : n) : (n === Ze && !t.offsetParent && t !== Ce && !r.svg && (l = i.display, i.display = "block", s = t.parentNode, (!s || !t.offsetParent) && (f = 1, o = t.nextElementSibling, Ce.appendChild(t)), n = Ki(t), l ? i.display = l : _e(t, "display"), f && (o ? s.insertBefore(t, o) : s ? s.appendChild(t) : Ce.removeChild(t))), e && n.length > 6 ? [n[0], n[1], n[4], n[5], n[12], n[13]] : n);
}, ri = function(t, e, r, i, n, s) {
  var o = t._gsap, l = n || ki(t, !0), f = o.xOrigin || 0, u = o.yOrigin || 0, h = o.xOffset || 0, _ = o.yOffset || 0, d = l[0], p = l[1], c = l[2], m = l[3], x = l[4], y = l[5], v = e.split(" "), w = parseFloat(v[0]) || 0, b = parseFloat(v[1]) || 0, T, k, S, C;
  r ? l !== Ze && (k = d * m - p * c) && (S = w * (m / k) + b * (-c / k) + (c * y - m * x) / k, C = w * (-p / k) + b * (d / k) - (d * y - p * x) / k, w = S, b = C) : (T = ns(t), w = T.x + (~v[0].indexOf("%") ? w / 100 * T.width : w), b = T.y + (~(v[1] || v[0]).indexOf("%") ? b / 100 * T.height : b)), i || i !== !1 && o.smooth ? (x = w - f, y = b - u, o.xOffset = h + (x * d + y * c) - x, o.yOffset = _ + (x * p + y * m) - y) : o.xOffset = o.yOffset = 0, o.xOrigin = w, o.yOrigin = b, o.smooth = !!i, o.origin = e, o.originIsAbsolute = !!r, t.style[gt] = "0px 0px", s && (qt(s, o, "xOrigin", f, w), qt(s, o, "yOrigin", u, b), qt(s, o, "xOffset", h, o.xOffset), qt(s, o, "yOffset", _, o.yOffset)), t.setAttribute("data-svg-origin", w + " " + b);
}, qe = function(t, e) {
  var r = t._gsap || new Wn(t);
  if ("x" in r && !e && !r.uncache)
    return r;
  var i = t.style, n = r.scaleX < 0, s = "px", o = "deg", l = getComputedStyle(t), f = jt(t, gt) || "0", u, h, _, d, p, c, m, x, y, v, w, b, T, k, S, C, M, N, A, R, I, z, F, Y, tt, ft, Mt, X, wt, it, Q, ut;
  return u = h = _ = c = m = x = y = v = w = 0, d = p = 1, r.svg = !!(t.getCTM && ss(t)), l.translate && ((l.translate !== "none" || l.scale !== "none" || l.rotate !== "none") && (i[q] = (l.translate !== "none" ? "translate3d(" + (l.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + (l.rotate !== "none" ? "rotate(" + l.rotate + ") " : "") + (l.scale !== "none" ? "scale(" + l.scale.split(" ").join(",") + ") " : "") + (l[q] !== "none" ? l[q] : "")), i.scale = i.rotate = i.translate = "none"), k = ki(t, r.svg), r.svg && (r.uncache ? (tt = t.getBBox(), f = r.xOrigin - tt.x + "px " + (r.yOrigin - tt.y) + "px", Y = "") : Y = !e && t.getAttribute("data-svg-origin"), ri(t, Y || f, !!Y || r.originIsAbsolute, r.smooth !== !1, k)), b = r.xOrigin || 0, T = r.yOrigin || 0, k !== Ze && (N = k[0], A = k[1], R = k[2], I = k[3], u = z = k[4], h = F = k[5], k.length === 6 ? (d = Math.sqrt(N * N + A * A), p = Math.sqrt(I * I + R * R), c = N || A ? ge(A, N) * ne : 0, y = R || I ? ge(R, I) * ne + c : 0, y && (p *= Math.abs(Math.cos(y * we))), r.svg && (u -= b - (b * N + T * R), h -= T - (b * A + T * I))) : (ut = k[6], it = k[7], Mt = k[8], X = k[9], wt = k[10], Q = k[11], u = k[12], h = k[13], _ = k[14], S = ge(ut, wt), m = S * ne, S && (C = Math.cos(-S), M = Math.sin(-S), Y = z * C + Mt * M, tt = F * C + X * M, ft = ut * C + wt * M, Mt = z * -M + Mt * C, X = F * -M + X * C, wt = ut * -M + wt * C, Q = it * -M + Q * C, z = Y, F = tt, ut = ft), S = ge(-R, wt), x = S * ne, S && (C = Math.cos(-S), M = Math.sin(-S), Y = N * C - Mt * M, tt = A * C - X * M, ft = R * C - wt * M, Q = I * M + Q * C, N = Y, A = tt, R = ft), S = ge(A, N), c = S * ne, S && (C = Math.cos(S), M = Math.sin(S), Y = N * C + A * M, tt = z * C + F * M, A = A * C - N * M, F = F * C - z * M, N = Y, z = tt), m && Math.abs(m) + Math.abs(c) > 359.9 && (m = c = 0, x = 180 - x), d = J(Math.sqrt(N * N + A * A + R * R)), p = J(Math.sqrt(F * F + ut * ut)), S = ge(z, F), y = Math.abs(S) > 2e-4 ? S * ne : 0, w = Q ? 1 / (Q < 0 ? -Q : Q) : 0), r.svg && (Y = t.getAttribute("transform"), r.forceCSS = t.setAttribute("transform", "") || !as(jt(t, q)), Y && t.setAttribute("transform", Y))), Math.abs(y) > 90 && Math.abs(y) < 270 && (n ? (d *= -1, y += c <= 0 ? 180 : -180, c += c <= 0 ? 180 : -180) : (p *= -1, y += y <= 0 ? 180 : -180)), e = e || r.uncache, r.x = u - ((r.xPercent = u && (!e && r.xPercent || (Math.round(t.offsetWidth / 2) === Math.round(-u) ? -50 : 0))) ? t.offsetWidth * r.xPercent / 100 : 0) + s, r.y = h - ((r.yPercent = h && (!e && r.yPercent || (Math.round(t.offsetHeight / 2) === Math.round(-h) ? -50 : 0))) ? t.offsetHeight * r.yPercent / 100 : 0) + s, r.z = _ + s, r.scaleX = J(d), r.scaleY = J(p), r.rotation = J(c) + o, r.rotationX = J(m) + o, r.rotationY = J(x) + o, r.skewX = y + o, r.skewY = v + o, r.transformPerspective = w + s, (r.zOrigin = parseFloat(f.split(" ")[2]) || !e && r.zOrigin || 0) && (i[gt] = xr(f)), r.xOffset = r.yOffset = 0, r.force3D = bt.force3D, r.renderTransform = r.svg ? Xo : is ? ls : Uo, r.uncache = 0, r;
}, xr = function(t) {
  ...
  var r = e || this, i = r.xPercent, n = r.yPercent, s = r.x, o = r.y, l = r.z, f = r.rotation, u = r.rotationY, h = r.rotationX, _ = r.skewX, d = r.skewY, p = r.scaleX, c = r.scaleY, m = r.transformPerspective, x = r.force3D, y = r.target, v = r.zOrigin, w = "", b = x === "auto" && t && t !== 1 || x === !0;
  if (v && (h !== re || u !== re)) {
    var T = parseFloat(u) * we, k = Math.sin(T), S = Math.cos(T), C;
    T = parseFloat(h) * we, C = Math.cos(T), s = Fr(y, s, k * C * -v), o = Fr(y, o, -Math.sin(T) * -v), l = Fr(y, l, S * C * -v + v);
  }
  m !== Ae && (w += "perspective(" + m + ie), (i || n) && (w += "translate(" + i + "%, " + n + "%) "), (b || s !== Ae || o !== Ae || l !== Ae) && (w += l !== Ae || b ? "translate3d(" + s + ", " + o + ", " + l + ") " : "translate(" + s + ", " + o + ie), f !== re && (w += "rotate(" + f + ie), u !== re && (w += "rotateY(" + u + ie), h !== re && (w += "rotateX(" + h + ie), (_ !== re || d !== re) && (w += "skew(" + _ + ", " + d + ie), (p !== 1 || c !== 1) && (w += "scale(" + p + ", " + c + ie), y.style[q] = w || "translate(0, 0)";
}, Xo = function(t, e) {
  var r = e || this, i = r.xPercent, n = r.yPercent, s = r.x, o = r.y, l = r.rotation, f = r.skewX, u = r.skewY, h = r.scaleX, _ = r.scaleY, d = r.target, p = r.xOrigin, c = r.yOrigin, m = r.xOffset, x = r.yOffset, y = r.forceCSS, v = parseFloat(s), w = parseFloat(o), b, T, k, S, C;
  l = parseFloat(l), f = parseFloat(f), u = parseFloat(u), u && (u = parseFloat(u), f += u, l += u), l || f ? (l *= we, f *= we, b = Math.cos(l) * h, T = Math.sin(l) * h, k = Math.sin(l - f) * -_, S = Math.cos(l - f) * _, f && (u *= we, C = Math.tan(f - u), C = Math.sqrt(1 + C * C), k *= C, S *= C, u && (C = Math.tan(u), C = Math.sqrt(1 + C * C), b *= C, T *= C)), b = J(b), T = J(T), k = J(k), S = J(S)) : (b = h, S = _, T = k = 0), (v && !~(s + "").indexOf("px") || w && !~(o + "").indexOf("px")) && (v = Kt(d, "x", s, "px"), w = Kt(d, "y", o, "px")), (p || c || m || x) && (v = J(v + p - (p * b + c * k) + m), w = J(w + c - (p * T + c * S) + x)), (i || n) && (C = d.getBBox(), v = J(v + i / 100 * C.width), w = J(w + n / 100 * C.height)), C = "matrix(" + b + "," + T + "," + k + "," + S + "," + v + "," + w + ")", d.setAttribute("transform", C), y && (d.style[q] = C);
}, Go = function(t, e, r, i, n) {
  var s = 360, o = rt(n), l = parseFloat(n) * (o && ~n.indexOf("rad") ? ne : 1), f = l - i, u = i + f + "deg", h, _;
  return o && (h = n.split("_")[1], h === "short" && (f %= s, f !== f % (s / 2) && (f += f < 0 ? s : -s)), h === "cw" && f < 0 ? f = (f + s * Zi) % s - ~~(f / s) * s : h === "ccw" && f > 0 && (f = (f - s * Zi) % s - ~~(f / s) * s)), t._pt = _ = new pt(t._pt, e, r, i, f, Mo), _.e = u, _.u = "deg", t._props.push(r), _;
}, tn = function(t, e) {
  for (var r in e)
    t[r] = e[r];
  return t;
}, Zo = function(t, e, r) {
  var i = tn({}, r._gsap), n = "perspective,force3D,transformOrigin,svgOrigin", s = r.style, o, l, f, u, h, _, d, p;
  i.svg ? (f = r.getAttribute("transform"), r.setAttribute("transform", ""), s[q] = e, o = qe(r, 1), _e(r, q), r.setAttribute("transform", f)) : (f = getComputedStyle(r)[q], s[q] = e, o = qe(r, 1), s[q] = f);
  for (l in Ut)
    f = i[l], u = o[l], f !== u && n.indexOf(l) < 0 && (d = ot(f), p = ot(u), h = d !== p ? Kt(r, l, f, p) : parseFloat(f), _ = parseFloat(u), t._pt = new pt(t._pt, o, l, h, _ - h, Kr), t._pt.u = p || 0, t._props.push(l));
  tn(o, i);
};
dt("padding,margin,Width,Radius", function(a, t) {
  ...
  mr[t > 1 ? "border" + a : a] = function(o, l, f, u, h) {
    var _, d;
...
var fs = {
  ...
  init: function(t, e, r, i, n) {
    var s = this._props, o = t.style, l = r.vars.startAt, f, u, h, _, d, p, c, m, x, y, v, w, b, T, k, S;
    ...
    for (c in e)
      if (c !== "autoRound" && (u = e[c], !(xt[c] && Un(c, e, r, i, t, n)))) {
        if (d = typeof u, p = mr[c], d === "function" && (u = u.call(r, i, t, n), d = typeof u), d === "string" && ~u.indexOf("random(") && (u = Ue(u)), p)
          ...
          f = (getComputedStyle(t).getPropertyValue(c) + "").trim(), u += "", Jt.lastIndex = 0, Jt.test(f) || (m = ot(f), x = ot(u)), x ? m !== x && (f = Kt(t, c, f, x) + x) : m && (u += m), this.add(o, "setProperty", f, u, i, n, 0, 0, c), s.push(c), S.push(c, 0, o[c]);
        else if (d !== "undefined") {
          if (l && c in l ? (f = typeof l[c] == "function" ? l[c].call(r, i, t, n) : l[c], rt(f) && ~f.indexOf("random(") && (f = Ue(f)), ot(f + "") || f === "auto" || (f += bt.units[c] || ot(It(t, c)) || ""), (f + "").charAt(1) === "=" && (f = It(t, c))) : f = It(t, c), _ = parseFloat(f), y = d === "string" && u.charAt(1) === "=" && u.substr(0, 2), y && (u = u.substr(2)), h = parseFloat(u), c in Dt && (c === "autoAlpha" && (_ === 1 && It(t, "visibility") === "hidden" && h && (_ = 0), S.push("visibility", 0, o.visibility), qt(this, o, "visibility", _ ? "inherit" : "hidden", h ? "inherit" : "hidden", !h)), c !== "scale" && c !== "transform" && (c = Dt[c], ~c.indexOf(",") && (c = c.split(",")[0]))), v = c in Ut, v) {
            if (this.styles.save(c), w || (b = t._gsap, b.renderTransform && !e.parseTransform || qe(t, e.parseTransform), T = e.smoothOrigin !== !1 && b.smooth, w = this._pt = new pt(this._pt, o, q, 0, 1, b.renderTransform, b, 0, -1), w.dep = 1), c === "scale")
              ...
              S.push(gt, 0, o[gt]), u = Yo(u), b.svg ? ri(t, u, 0, T, 0, this) : (x = parseFloat(u.split(" ")[2]) || 0, x !== b.zOrigin && qt(this, b, "zOrigin", b.zOrigin, x), qt(this, o, c, xr(f), xr(u)));
              continue;
            } else if (c === "svgOrigin") {
              ri(t, u, 1, T, 0, this);
              continue;
          ...
          if (v || (h || h === 0) && (_ || _ === 0) && !Oo.test(u) && c in o)
            m = (f + "").substr((_ + "").length), h || (h = 0), x = ot(u) || (c in bt.units ? bt.units[c] : m), m !== x && (_ = Kt(t, c, f, x)), this._pt = new pt(this._pt, v ? b : o, c, _, (y ? be(_, y + h) : h) - _, !v && (x === "px" || c === "zIndex") && e.autoRound !== !1 ? Ro : Kr), this._pt.u = x || 0, m !== x && x !== "%" && (this._pt.b = f, this._pt.r = No);
          else if (c in o)
            $o.call(this, t, c, f, y ? y + u : u);
          else if (c in t)
            this.add(t, c, f || t[c], y ? y + u : u, i, n);
          else if (c !== "parseTransform") {
            _i(c, u);
            continue;
          }
          v || (c in o ? S.push(c, 0, o[c]) : S.push(c, 1, f || t[c])), s.push(c);
        }
      }
    k && Jn(this);
  },
...
function ca(a, t) {
  var e = a.tagName.toLowerCase(), r = 0.552284749831, i, n, s, o, l, f, u, h, _, d, p, c, m, x, y, v, w, b, T, k, S, C;
  return e === "path" || !a.getBBox ? a : (f = fa(a, "x,y,width,height,cx,cy,rx,ry,r,x1,x2,y1,y2,points"), C = ha(a, ua[e]), e === "rect" ? (o = C.rx, l = C.ry || o, n = C.x, s = C.y, d = C.width - o * 2, p = C.height - l * 2, o || l ? (c = n + o * (1 - r), m = n + o, x = m + d, y = x + o * r, v = x + o, w = s + l * (1 - r), b = s + l, T = b + p, k = T + l * r, S = T + l, i = "M" + v + "," + b + " V" + T + " C" + [v, k, y, S, x, S, x - (x - m) / 3, S, m + (x - m) / 3, S, m, S, c, S, n, k, n, T, n, T - (T - b) / 3, n, b + (T - b) / 3, n, b, n, w, c, s, m, s, m + (x - m) / 3, s, x - (x - m) / 3, s, x, s, y, s, v, w, v, b].join(",") + "z") : i = "M" + (n + d) + "," + s + " v" + p + " h" + -d + " v" + -p + " h" + d + "z") : e === "circle" || e === "ellipse" ? (e === "circle" ? (o = l = C.r, h = o * r) : (o = C.rx, l = C.ry, h = l * r), n = C.cx, s = C.cy, u = o * r, i = "M" + (n + o) + "," + s + " C" + [n + o, s + h, n + u, s + l, n, s + l, n - u, s + l, n - o, s + h, n - o, s, n - o, s - h, n - u, s - l, n, s - l, n + u, s - l, n + o, s - h, n + o, s].join(",") + "z") : e === "line" ? i = "M" + C.x1 + "," + C.y1 + " L" + C.x2 + "," + C.y2 : (e === "polyline" || e === "polygon") && (_ = (a.getAttribute("points") + "").match(Ho) || [], n = _.shift(), s = _.shift(), i = "M" + n + "," + s + " L" + _.join(","), e === "polygon" && (i += "," + n + "," + s + "z")), f.setAttribute("d", ps(f._gsRawPath = vr(i))), t && a.parentNode && (a.parentNode.insertBefore(f, a), a.parentNode.removeChild(a)), f);
}
function _s(a, t, e) {
...
function ds(a, t, e) {
  ...
  i.totalLength || ue(i);
  var s = e > 1, o = on(i, t, ia, !0), l = on(i, e, na), f = l.segment, u = o.segment, h = l.segIndex, _ = o.segIndex, d = l.i, p = o.i, c = _ === h, m = d === p && c, x, y, v, w, b, T, k, S;
  if (s || r) {
    for (x = h < _ || c && d < p || m && l.t < o.t, nn(i, _, p, o.t) && (_++, x || (h++, m ? (l.t = (l.t - o.t) / (1 - o.t), d = 0) : c && (d -= p))), Math.abs(1 - (e - t)) < 1e-5 ? h = _ - 1 : !l.t && h ? h-- : nn(i, h, d, l.t) && x && _++, o.t === 1 && (_ = (_ + 1) % i.length), b = [], T = i.length, k = 1 + T * r, S = _, k += (T - _ + h) % T, w = 0; w < k; w++)
      oa(b, i[S++ % T]);
    i = b;
  } else if (v = l.t === 1 ? 6 : ni(f, d, l.t), t !== e)
    for (y = ni(u, p, m ? o.t / l.t : o.t), c && (v += y), f.splice(d + v + 2), (y || p) && u.splice(0, p + y), w = i.length; w--; )
      (w < _ || w > h) && i.splice(w, 1);
  else
    f.angle = _s(f, d + v, 0), d += v, o = f[d], l = f[d + 1], f.length = f.totalLength = 0, f.totalPoints = i.totalPoints = 8, f.push(o, l, o, l, o, l, o, l);
  return i.totalLength = 0, i;
}
function _a(a, t, e) {
  t = t || 0, a.samples || (a.samples = [], a.lookup = []);
  var r = ~~a.resolution || 12, i = 1 / r, n = a.length, s = a[t], o = a[t + 1], l = t ? t / 6 * r : 0, f = a.samples, u = a.lookup, h = (t ? a.minLength : ii) || ii, _ = f[l + e * r - 1], d = t ? f[l - 1] : 0, p, c, m, x, y, v, w, b, T, k, S, C, M, N, A, R, I;
  for (f.length = u.length = 0, c = t + 2; c < n; c += 6) {
    if (m = a[c + 4] - s, x = a[c + 2] - s, y = a[c] - s, b = a[c + 5] - o, T = a[c + 3] - o, k = a[c + 1] - o, v = w = S = C = 0, Pt(m) < 0.01 && Pt(b) < 0.01 && Pt(y) + Pt(k) < 0.01)
      ...
      for (p = 1; p <= r; p++)
        N = i * p, M = 1 - N, v = w - (w = (N * N * m + 3 * M * (N * x + M * y)) * N), S = C - (C = (N * N * b + 3 * M * (N * T + M * k)) * N), R = $t(S * S + v * v), R < h && (h = R), d += R, f[l++] = d;
    s += m, o += b;
  }
  if (_)
    for (_ -= d; l < f.length; l++)
      f[l] += _;
  if (f.length && h) {
    if (a.totalLength = I = f[f.length - 1] || 0, a.minLength = h, I / h < 9999)
      for (R = A = 0, p = 0; p < I; p += h)
        u[R++] = f[A] < p ? ++A : A;
  } else
    a.totalLength = f[0] = 0;
  return t ? d - f[t / 2 - 1] : d;
}
function ue(a, t) {
  var e, r, i;
...
function ni(a, t, e) {
  if (e <= 0 || e >= 1)
    return 0;
  var r = a[t], i = a[t + 1], n = a[t + 2], s = a[t + 3], o = a[t + 4], l = a[t + 5], f = a[t + 6], u = a[t + 7], h = r + (n - r) * e, _ = n + (o - n) * e, d = i + (s - i) * e, p = s + (l - s) * e, c = h + (_ - h) * e, m = d + (p - d) * e, x = o + (f - o) * e, y = l + (u - l) * e;
...
function on(a, t, e, r) {
  ...
  if (!t)
    ...
    if (a.length > 1) {
      for (l = a.totalLength * t, u = h = 0; (u += a[h++].totalLength) < l; )
        i = h;
      n = a[i], f = u - n.totalLength, t = (l - f) / (u - f) || 0;
    }
    s = n.samples, o = n.resolution, l = n.totalLength * t, h = n.lookup.length ? n.lookup[~~(l / n.minLength)] || 0 : cs(s, l, t), f = h ? s[h - 1] : 0, u = s[h], u < l && (f = u, u = s[++h]), _ = 1 / o * ((l - f) / (u - f) + h % o), h = ~~(h / o) * 6, r && _ === 1 && (h + 6 < n.length ? (h += 6, _ = 0) : i + 1 < a.length && (h = _ = 0, n = a[++i]));
  }
  return e.t = _, e.i = h, e.path = a, e.segment = n, e.segIndex = i, e;
}
function an(a, t, e, r) {
  var i = a[0], n = r || {}, s, o, l, f, u, h, _, d, p;
  if ((t < 0 || t > 1) && (t = hs(t)), i.lookup || ue(a), a.length > 1) {
    for (l = a.totalLength * t, u = h = 0; (u += a[h++].totalLength) < l; )
      i = a[h];
    f = u - i.totalLength, t = (l - f) / (u - f) || 0;
  }
  return s = i.samples, o = i.resolution, l = i.totalLength * t, h = i.lookup.length ? i.lookup[t < 1 ? ~~(l / i.minLength) : i.lookup.length - 1] || 0 : cs(s, l, t), f = h ? s[h - 1] : 0, u = s[h], u < l && (f = u, u = s[++h]), _ = 1 / o * ((l - f) / (u - f) + h % o) || 0, p = 1 - _, h = ~~(h / o) * 6, d = i[h], n.x = V((_ * _ * (i[h + 6] - d) + 3 * p * (_ * (i[h + 4] - d) + p * (i[h + 2] - d))) * _ + d), n.y = V((_ * _ * (i[h + 7] - (d = i[h + 1])) + 3 * p * (_ * (i[h + 5] - d) + p * (i[h + 3] - d))) * _ + d), e && (n.angle = i.totalLength ? _s(i, h, _ >= 1 ? 1 - 1e-9 : _ || 1e-9) : i.angle || 0), n;
}
function ze(a, t, e, r, i, n, s) {
  for (var o = a.length, l, f, u, h, _; --o > -1; )
    for (l = a[o], f = l.length, u = 0; u < f; u += 2)
      h = l[u], _ = l[u + 1], l[u] = h * t + _ * r + n, l[u + 1] = h * e + _ * i + s;
  return a._dirty = 1, a;
}
function da(a, t, e, r, i, n, s, o, l) {
  if (!(a === o && t === l)) {
    e = Pt(e), r = Pt(r);
    var f = i % 360 * Ko, u = or(f), h = sr(f), _ = Math.PI, d = _ * 2, p = (a - o) / 2, c = (t - l) / 2, m = u * p + h * c, x = -h * p + u * c, y = m * m, v = x * x, w = y / (e * e) + v / (r * r);
    w > 1 && (e = $t(w) * e, r = $t(w) * r);
    var b = e * e, T = r * r, k = (b * T - b * v - T * y) / (b * v + T * y);
    k < 0 && (k = 0);
    var S = (n === s ? -1 : 1) * $t(k), C = S * (e * x / r), M = S * -(r * m / e), N = (a + o) / 2, A = (t + l) / 2, R = N + (u * C - h * M), I = A + (h * C + u * M), z = (m - C) / e, F = (x - M) / r, Y = (-m - C) / e, tt = (-x - M) / r, ft = z * z + F * F, Mt = (F < 0 ? -1 : 1) * Math.acos(z / $t(ft)), X = (z * tt - F * Y < 0 ? -1 : 1) * Math.acos((z * Y + F * tt) / $t(ft * (Y * Y + tt * tt)));
...
function vr(a) {
  ...
  }).match(qo) || [], e = [], r = 0, i = 0, n = 2 / 3, s = t.length, o = 0, l = "ERROR: malformed path: " + a, f, u, h, _, d, p, c, m, x, y, v, w, b, T, k, S = function(M, N, A, R) {
    y = (A - M) / 3, v = (R - N) / 3, c.push(M + y, N + v, A - y, R - v, A, R);
  };
  if (!a || !isNaN(t[0]) || isNaN(t[1]))
    return console.log(l), e;
  for (f = 0; f < s; f++)
    if (b = d, isNaN(t[f]) ? (d = t[f].toUpperCase(), p = d !== t[f]) : f--, h = +t[f + 1], _ = +t[f + 2], p && (h += r, _ += i), f || (m = h, x = _), d === "M")
      c && (c.length < 8 ? e.length -= 1 : o += c.length), r = m = h, i = x = _, c = [h, _], e.push(c), f += 2, d = "L";
    else if (d === "C")
      c || (c = [0, 0]), p || (r = i = 0), c.push(h, _, r + t[f + 3] * 1, i + t[f + 4] * 1, r += t[f + 5] * 1, i += t[f + 6] * 1), f += 6;
    else if (d === "S")
      y = r, v = i, (b === "C" || b === "S") && (y += r - c[c.length - 4], v += i - c[c.length - 3]), p || (r = i = 0), c.push(y, v, h, _, r += t[f + 3] * 1, i += t[f + 4] * 1), f += 4;
    else if (d === "Q")
      y = r + (h - r) * n, v = i + (_ - i) * n, p || (r = i = 0), r += t[f + 3] * 1, i += t[f + 4] * 1, c.push(y, v, r + (h - r) * n, i + (_ - i) * n, r, i), f += 4;
    else if (d === "T")
      y = r - c[c.length - 4], v = i - c[c.length - 3], c.push(r + y, i + v, h + (r + y * 1.5 - h) * n, _ + (i + v * 1.5 - _) * n, r = h, i = _), f += 2;
    else if (d === "H")
      S(r, i, r = h, i), f += 1;
    else if (d === "V")
      S(r, i, r, i = h + (p ? i - r : 0)), f += 1;
    else if (d === "L" || d === "Z")
      d === "Z" && (h = m, _ = x, c.closed = !0), (d === "L" || Pt(r - h) > 0.5 || Pt(i - _) > 0.5) && (S(r, i, h, _), d === "L" && (f += 2)), r = h, i = _;
    else if (d === "A") {
      if (T = t[f + 4], k = t[f + 5], y = t[f + 6], v = t[f + 7], u = 7, T.length > 1 && (T.length < 3 ? (v = y, y = k, u--) : (v = k, y = T.substr(2), u -= 2), k = T.charAt(1), T = T.charAt(0)), w = da(r, i, +t[f + 1], +t[f + 2], +t[f + 3], +T, +k, (p ? r : 0) + y * 1, (p ? i : 0) + v * 1), f += u, w)
        for (u = 0; u < w.length; u++)
          c.push(w[u]);
      r = c[c.length - 2], i = c[c.length - 1];
    } else
      console.log(l);
  return f = c.length, f < 6 ? (e.pop(), f = 0) : c[0] === c[f - 2] && c[1] === c[f - 1] && (c.closed = !0), e.totalPoints = o + f, e;
}
function pa(a, t) {
  t === void 0 && (t = 1);
...
function si(a, t) {
  ...
  var e = a.length - 2, r = +a[0], i = +a[1], n = +a[2], s = +a[3], o = [r, i, r, i], l = n - r, f = s - i, u = Math.abs(a[e] - r) < 1e-3 && Math.abs(a[e + 1] - i) < 1e-3, h, _, d, p, c, m, x, y, v, w, b, T, k, S, C;
  for (u && (a.push(n, s), n = r, s = i, r = a[e - 2], i = a[e - 1], a.unshift(r, i), e += 4), t = t || t === 0 ? +t : 1, d = 2; d < e; d += 2)
    h = r, _ = i, r = n, i = s, n = +a[d + 2], s = +a[d + 3], !(r === n && i === s) && (p = l, c = f, l = n - r, f = s - i, m = $t(p * p + c * c), x = $t(l * l + f * f), y = $t(Math.pow(l / x + p / m, 2) + Math.pow(f / x + c / m, 2)), v = (m + x) * t * 0.25 / y, w = r - (r - h) * (m ? v / m : 0), b = r + (n - r) * (x ? v / x : 0), T = r - (w + ((b - w) * (m * 3 / (m + x) + 0.5) / 4 || 0)), k = i - (i - _) * (m ? v / m : 0), S = i + (s - i) * (x ? v / x : 0), C = i - (k + ((S - k) * (m * 3 / (m + x) + 0.5) / 4 || 0)), (r !== h || i !== _) && o.push(
      V(w + T),
      // first control point
      V(k + C),
      V(r),
...
var Yt, he, Si, Sr, Fe, hr, br, $e, Rt = "transform", oi = Rt + "Origin", gs, ms = function(t) {
  ...
  if (t.parentNode && (Yt || ms(t))) {
    var r = Ei(t), i = r ? r.getAttribute("xmlns") || "http://www.w3.org/2000/svg" : "http://www.w3.org/1999/xhtml", n = r ? e ? "rect" : "g" : "div", s = e !== 2 ? 0 : 100, o = e === 3 ? 100 : 0, l = "position:absolute;display:block;pointer-events:none;margin:0;padding:0;", f = Yt.createElementNS ? Yt.createElementNS(i.replace(/^https/, "http"), n) : Yt.createElement(n);
    return e && (r ? (hr || (hr = a(t)), f.setAttribute("width", 0.01), f.setAttribute("height", 0.01), f.setAttribute("transform", "translate(" + s + "," + o + ")"), hr.appendChild(f)) : (Fe || (Fe = a(t), Fe.style.cssText = l), f.style.cssText = l + "width:0.1px;height:0.1px;top:" + o + "px;left:" + s + "px", Fe.appendChild(f))), f;
  }
  ...
  var r = Ei(t), i = t === r, n = r ? xs : ys, s = t.parentNode, o, l, f, u, h, _;
  if (t === he)
    return t;
  if (n.length || n.push(Br(t, 1), Br(t, 2), Br(t, 3)), o = r ? hr : Fe, r)
    i ? (f = ba(t), u = -f.e / f.a, h = -f.f / f.d, l = br) : t.getBBox ? (f = t.getBBox(), l = t.transform ? t.transform.baseVal : {}, l = l.numberOfItems ? l.numberOfItems > 1 ? va(l) : l.getItem(0).matrix : br, u = l.a * f.x + l.c * f.y, h = l.b * f.x + l.d * f.y) : (l = new He(), u = h = 0), e && t.tagName.toLowerCase() === "g" && (u = h = 0), (i ? r : s).appendChild(o), o.setAttribute("transform", "matrix(" + l.a + "," + l.b + "," + l.c + "," + l.d + "," + (l.e + u) + "," + (l.f + h) + ")");
  else {
    if (u = h = 0, gs)
      for (l = t.offsetParent, f = t; f && (f = f.parentNode) && f !== l && f.parentNode; )
        (he.getComputedStyle(f)[Rt] + "").length > 4 && (u = f.offsetLeft, h = f.offsetTop, f = 0);
    ...
    f = o.style, f.top = t.offsetTop - h + "px", f.left = t.offsetLeft - u + "px", f[Rt] = _[Rt], f[oi] = _[oi], f.position = _.position === "fixed" ? "fixed" : "absolute", t.parentNode.appendChild(o);
  }
  return o;
  ...
  return t.inverse = function() {
    var r = this.a, i = this.b, n = this.c, s = this.d, o = this.e, l = this.f, f = r * s - i * n || 1e-10;
    return Vr(this, s / f, -i / f, -n / f, r / f, (n * l - s * o) / f, -(r * l - i * o) / f);
  }, t.multiply = function(r) {
    var i = this.a, n = this.b, s = this.c, o = this.d, l = this.e, f = this.f, u = r.a, h = r.c, _ = r.b, d = r.d, p = r.e, c = r.f;
    return Vr(this, u * i + _ * s, u * n + _ * o, h * i + d * s, h * n + d * o, l + p * i + c * s, f + p * n + c * o);
  }, t.clone = function() {
    return new a(this.a, this.b, this.c, this.d, this.e, this.f);
  }, t.equals = function(r) {
    var i = this.a, n = this.b, s = this.c, o = this.d, l = this.e, f = this.f;
    return i === r.a && n === r.b && s === r.c && o === r.d && l === r.e && f === r.f;
  }, t.apply = function(r, i) {
    i === void 0 && (i = {});
    var n = r.x, s = r.y, o = this.a, l = this.b, f = this.c, u = this.d, h = this.e, _ = this.f;
    return i.x = n * o + s * f + h || 0, i.y = n * l + s * u + _ || 0, i;
  }, a;
}();
function Te(a, t, e, r) {
  if (!a || !a.parentNode || (Yt || ms(a)).documentElement === a)
    return new He();
  var i = ga(a), n = Ei(a), s = n ? xs : ys, o = Ca(a, e), l = s[0].getBoundingClientRect(), f = s[1].getBoundingClientRect(), u = s[2].getBoundingClientRect(), h = o.parentNode, _ = !r && ya(a), d = new He((f.left - l.left) / 100, (f.top - l.top) / 100, (u.left - l.left) / 100, (u.top - l.top) / 100, l.left + (_ ? 0 : xa()), l.top + (_ ? 0 : ma()));
  if (h.removeChild(o), i)
    for (l = i.length; l--; )
      f = i[l], f.scaleX = f.scaleY = 0, f.renderTransform(1, f);
...
var wa = "x,translateX,left,marginLeft,xPercent".split(","), Ta = "y,translateY,top,marginTop,yPercent".split(","), ka = Math.PI / 180, kt, vs, me, ai, Ir, ln, Sa = function() {
  ...
  for (i = 2; i < t.length; i += 2)
    e = t[i] += e, r = t[i + 1] += r;
}, fn = function(t, e, r, i, n, s, o, l, f) {
  if (o.type === "cubic")
    e = [e];
  else {
    o.fromCurrent !== !1 && e.unshift(ve(r, i, l), n ? ve(r, n, f) : 0), o.relative && bs(e);
    var u = n ? si : pa;
    e = [u(e, o.curviness)];
  }
  return e = s(Cs(e, r, o)), Cr(t, r, i, e, "x", l), n && Cr(t, r, n, e, "y", f), ue(e, o.resolution || (o.curviness === 0 ? 20 : 12));
}, Ea = function(t) {
  return t;
  ...
  var n = Te(t.parentNode, !0, !0), s = n.clone().multiply(Te(e)), o = un(t, r, n), l = un(e, i, n), f = l.x, u = l.y, h;
  return s.e = s.f = 0, i === "auto" && e.getTotalLength && e.tagName.toLowerCase() === "path" && (h = e.getAttribute("d").match(Pa) || [], h = s.apply({
    x: +h[0],
    y: +h[1]
  }), f += h.x, u += h.y), h && (h = s.apply(e.getBBox()), f -= h.x, u -= h.y), s.e = f - o.x, s.f = u - o.y, s;
}, Cs = function(t, e, r) {
  var i = r.align, n = r.matrix, s = r.offsetX, o = r.offsetY, l = r.alignOrigin, f = t[0][0], u = t[0][1], h = ve(e, "x"), _ = ve(e, "y"), d, p, c;
  return !t || !t.length ? ur("M0,0L0,0") : (i && (i === "self" || (d = ai(i)[0] || e) === e ? ze(t, 1, 0, 0, 1, h - f, _ - u) : (l && l[2] !== !1 ? kt.set(e, {
    transformOrigin: l[0] * 100 + "% " + l[1] * 100 + "%"
  }) : l = [ve(e, "xPercent") / -100, ve(e, "yPercent") / -100], p = li(e, d, l, "auto"), c = p.apply({
    x: f,
    y: u
  ...
  var o = e._gsap, l = o.harness, f = l && l.aliases && l.aliases[r], u = f && f.indexOf(",") < 0 ? f : r, h = t._pt = new vs(t._pt, e, u, 0, 0, Ea, 0, o.set(e, u, t));
  ...
  init: function(t, e, r) {
    ...
    var i = [], n = e, s = n.path, o = n.autoRotate, l = n.unitX, f = n.unitY, u = n.x, h = n.y, _ = s[0], d = Oa(e.start, "end" in e ? e.end : 1), p, c;
    if (this.rawPaths = i, this.target = t, this.tween = r, this.styles = Ir && Ir(t, "transform"), (this.rotate = o || o === 0) && (this.rOffset = parseFloat(o) || 0, this.radians = !!e.useRadians, this.rProp = e.rotation || "rotation", this.rSet = t._gsap.set(t, this.rProp, this), this.ru = me(t._gsap.get(t, this.rProp)) || 0), Array.isArray(s) && !("closed" in s) && typeof _ != "number") {
      ...
      u && h ? i.push(fn(this, Le(Le([], s, u, 0), s, h, 1), t, u, h, d, e, l || me(s[0][u]), f || me(s[0][h]))) : u = h = 0;
      for (c in _)
...
const ja = ({ children: a }) => /* @__PURE__ */ O.jsxs("div", { className: "relative flex flex-col min-h-screen bg-gray-100 dark:bg-darkGrayBg theme-text font-[RobotoCondensed] ", children: [
  ...
  const e = Li(null), r = Li(
    ...
    const l = Nt.utils.selector(e.current), f = l(".stroke-fng");
    n(f), i(l), r.current.play();
  }, o = () => {
    if (e.current) {
      const l = Nt.utils.selector(e.current), f = l(".stroke-fng");
      r.current.reverse(), Nt.killTweensOf(f), n(f, !0), Nt.killTweensOf(l(".scanner")), Nt.set(l(".scanner"), { y: 0, opacity: 0 });
    }
  };
  return /* @__PURE__ */ O.jsx(
    "button",
    {
      ...
      children: /* @__PURE__ */ O.jsx(Ma, { ref: e })
    }
  );
};
export {
